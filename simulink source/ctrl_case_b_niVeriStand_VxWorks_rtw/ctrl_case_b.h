...
#ifndef RTW_HEADER_ctrl_case_b_h_
#define RTW_HEADER_ctrl_case_b_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef ctrl_case_b_COMMON_INCLUDES_
# define ctrl_case_b_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "zero_crossing_types.h"
#include "simstruc.h"
#include "fixedpoint.h"
#include "rt_logging.h"
#endif                                 /* ctrl_case_b_COMMON_INCLUDES_ */

#include "ctrl_case_b_types.h"
...
#define ctrl_case_b_rtModel            RT_MODEL_ctrl_case_b_T

/* Block signals (auto storage) */
typedef struct {
  real_T y_in;                         /* '<Root>/y_in' */
  real_T noise_power_p;                /* '<Root>/noise_power_p' */
  real_T WhiteNoise;                   /* '<S15>/White Noise' */
  real_T WhiteNoise_e;                 /* '<S16>/White Noise' */
  real_T noise_power_psi;              /* '<Root>/noise_power_psi' */
  ...
  real_T Memory_a;                     /* '<S7>/Memory' */
  real_T Memory1;                      /* '<S7>/Memory1' */
  real_T Gain_n;                       /* '<Root>/Gain' */
  real_T u_vsp;                        /* '<S7>/MATLAB Function' */
  real_T u_bt;                         /* '<S7>/MATLAB Function' */
  real_T alpha;                        /* '<S7>/MATLAB Function' */
  real_T omega;                        /* '<S7>/MATLAB Function' */
  real_T mem_out;                      /* '<S7>/MATLAB Function' */
  real_T hold_out;                     /* '<S7>/MATLAB Function' */
  real_T y;                            /* '<S6>/Integration block ' */
  real_T nu_dot[3];                    /* '<S5>/kinetics' */
  real_T eta_dot[3];                   /* '<S5>/kinematics' */
  real_T output[3];                    /* '<S10>/MATLAB Function1' */
  real_T count;                        /* '<S9>/MATLAB Function' */
  real_T thrust_out[2];                /* '<Root>/MATLAB Function2' */
  real_T eta[3];                       /* '<Root>/MATLAB Function1' */
  real_T dead_x;                       /* '<Root>/MATLAB Function' */
  real_T newmem[9];                    /* '<Root>/MATLAB Function' */
} B_ctrl_case_b_T;
...
typedef struct {
  ...
  real_T v_newModel_DWORK1;            /* '<Root>/v_newModel' */
  real_T r_in_DWORK1;                  /* '<Root>/r_in' */
  real_T u_newModel_DWORK1;            /* '<Root>/u_newModel' */
  real_T v_in_DWORK1;                  /* '<Root>/v_in' */
  real_T r_newModel_DWORK1;            /* '<Root>/r_newModel' */
  real_T u_dot_imu_DWORK1;             /* '<Root>/u_dot_imu' */
  real_T psi_newModel1_DWORK1;         /* '<Root>/psi_newModel1' */
  real_T x_newModel1_DWORK1;           /* '<Root>/x_newModel1' */
  real_T y_newModel1_DWORK1;           /* '<Root>/y_newModel1' */
  ...
  real_T Combine_DWORK1;               /* '<S7>/Combine' */
  ...
  } Integrator1_IWORK;                 /* '<S5>/Integrator1' */
  ...
  uint8_T y_in_DWORK2[12];             /* '<Root>/y_in' */
  uint8_T noise_power_p_DWORK2[12];    /* '<Root>/noise_power_p' */
  uint8_T noise_power_psi_DWORK2[12];  /* '<Root>/noise_power_psi' */
  uint8_T reset_DWORK2[12];            /* '<Root>/reset' */
  uint8_T noise_DWORK2[12];            /* '<Root>/noise' */
  uint8_T k_0_DWORK2[12];              /* '<Root>/k_0' */
  uint8_T u_hat_DWORK2[12];            /* '<Root>/u_hat' */
  uint8_T psi_in_DWORK2[12];           /* '<Root>/psi_in' */
  uint8_T x_DWORK2[12];                /* '<Root>/x' */
  uint8_T x_in_DWORK2[12];             /* '<Root>/x_in' */
  uint8_T y_DWORK2[12];                /* '<Root>/y' */
  uint8_T psi_DWORK2[12];              /* '<Root>/psi' */
  uint8_T u_in_DWORK2[12];             /* '<Root>/u_in' */
  uint8_T v_newModel_DWORK2[12];       /* '<Root>/v_newModel' */
  uint8_T r_in_DWORK2[12];             /* '<Root>/r_in' */
  uint8_T u_newModel_DWORK2[12];       /* '<Root>/u_newModel' */
  uint8_T v_in_DWORK2[12];             /* '<Root>/v_in' */
  uint8_T r_newModel_DWORK2[12];       /* '<Root>/r_newModel' */
  uint8_T u_dot_imu_DWORK2[12];        /* '<Root>/u_dot_imu' */
  uint8_T psi_newModel1_DWORK2[12];    /* '<Root>/psi_newModel1' */
  uint8_T x_newModel1_DWORK2[12];      /* '<Root>/x_newModel1' */
  uint8_T y_newModel1_DWORK2[12];      /* '<Root>/y_newModel1' */
  uint8_T L2_continuous_DWORK2[12];    /* '<S7>/L2_continuous' */
  uint8_T PosYRight_DWORK2[12];        /* '<S7>/PosYRight' */
  uint8_T PosXRight_DWORK2[12];        /* '<S7>/PosXRight' */
  uint8_T R2_continuous_DWORK2[12];    /* '<S7>/R2_continuous' */
  uint8_T ArrowUp_DWORK2[12];          /* '<S7>/ArrowUp' */
  ...
  uint8_T Combine_DWORK2[12];          /* '<S7>/Combine' */
  uint8_T X_d_DWORK2[12];              /* '<S8>/X_d' */
  uint8_T N_d_DWORK2[12];              /* '<S8>/N_d' */
  uint8_T Y_d_DWORK2[12];              /* '<S8>/Y_d' */
  uint8_T psi_0_DWORK2[12];            /* '<S8>/psi_0 ' */
  uint8_T x_0_DWORK2[12];              /* '<S8>/x_0' */
  uint8_T y_0_DWORK2[12];              /* '<S8>/y_0' */
  uint8_T integratorresetmodel_DWORK2[12];/* '<S8>/integrator reset model' */
...
typedef struct {
  ...
  ZCSigState IntegratorSecondOrder_Reset_ZCE;/* '<Root>/Integrator, Second-Order' */
  ZCSigState Integrator_Reset_ZCE;     /* '<S6>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_h;   /* '<S5>/Integrator' */
} PrevZCX_ctrl_case_b_T;
...
#define rtB                            ctrl_case_b_B
#define BlockIO                        B_ctrl_case_b_T
#define rtX                            ctrl_case_b_X
#define ContinuousStates               X_ctrl_case_b_T
#define rtXdot                         ctrl_case_b_XDot
#define StateDerivatives               XDot_ctrl_case_b_T
#define tXdis                          ctrl_case_b_XDis
#define StateDisabled                  XDis_ctrl_case_b_T
#define rtP                            ctrl_case_b_P
#define Parameters                     P_ctrl_case_b_T
#define rtDWork                        ctrl_case_b_DW
#define D_Work                         DW_ctrl_case_b_T
#define rtPrevZCSigState               ctrl_case_b_PrevZCX
#define PrevZCSigStates                PrevZCX_ctrl_case_b_T

/* Parameters (auto storage) */
struct P_ctrl_case_b_T_ {
  ...
  real_T Constant1_Value;              /* Expression: 100
                                        ...
                                        */
  real_T noise_power_p_P1;             /* Expression: width
                                        * Referenced by: '<Root>/noise_power_p'
                                        */
  real_T noise_power_p_P2;             /* Expression: dtype
                                        * Referenced by: '<Root>/noise_power_p'
                                        */
  real_T noise_power_p_P3;             /* Expression: portnum
                                        * Referenced by: '<Root>/noise_power_p'
                                        */
  real_T noise_power_p_P4;             /* Expression: stime
                                        * Referenced by: '<Root>/noise_power_p'
                                        */
  real_T noise_power_p_P5;             /* Expression: stype
                                        * Referenced by: '<Root>/noise_power_p'
                                        */
  real_T noise_power_p_P6;             /* Expression: btype
                                        * Referenced by: '<Root>/noise_power_p'
                                        */
  ...
  real_T WhiteNoise_Seed_b;            /* Expression: 123
                                        * Referenced by: '<S16>/White Noise'
                                        */
  real_T noise_power_psi_P1;           /* Expression: width
                                        * Referenced by: '<Root>/noise_power_psi'
                                        */
  real_T noise_power_psi_P2;           /* Expression: dtype
                                        * Referenced by: '<Root>/noise_power_psi'
                                        */
  real_T noise_power_psi_P3;           /* Expression: portnum
                                        * Referenced by: '<Root>/noise_power_psi'
                                        */
  real_T noise_power_psi_P4;           /* Expression: stime
                                        * Referenced by: '<Root>/noise_power_psi'
                                        */
  real_T noise_power_psi_P5;           /* Expression: stype
                                        * Referenced by: '<Root>/noise_power_psi'
                                        */
  real_T noise_power_psi_P6;           /* Expression: btype
                                        * Referenced by: '<Root>/noise_power_psi'
                                        */
  ...
  real_T Hold_X0;                      /* Expression: 0
                                        ...
                                        */
  real_T noise_P1;                     /* Expression: width
                                        * Referenced by: '<Root>/noise'
                                        */
  real_T noise_P2;                     /* Expression: dtype
                                        * Referenced by: '<Root>/noise'
                                        */
  real_T noise_P3;                     /* Expression: portnum
                                        * Referenced by: '<Root>/noise'
                                        */
  real_T noise_P4;                     /* Expression: stime
                                        * Referenced by: '<Root>/noise'
                                        */
  real_T noise_P5;                     /* Expression: stype
                                        * Referenced by: '<Root>/noise'
                                        */
  real_T noise_P6;                     /* Expression: btype
                                        * Referenced by: '<Root>/noise'
                                        */
  ...
  real_T Integrator_IC[3];             /* Expression: [0 0 0]'
                                        ...
                                        */
  real_T v_newModel_P1;                /* Expression: width
                                        * Referenced by: '<Root>/v_newModel'
                                        */
  real_T v_newModel_P2;                /* Expression: dtype
                                        * Referenced by: '<Root>/v_newModel'
                                        */
  real_T v_newModel_P3;                /* Expression: portnum
                                        * Referenced by: '<Root>/v_newModel'
                                        */
  real_T v_newModel_P4;                /* Expression: stime
                                        * Referenced by: '<Root>/v_newModel'
                                        */
  real_T v_newModel_P5;                /* Expression: stype
                                        * Referenced by: '<Root>/v_newModel'
                                        */
  real_T v_newModel_P6;                /* Expression: btype
                                        * Referenced by: '<Root>/v_newModel'
                                        */
  ...
  real_T r_in_P6;                      /* Expression: btype
                                        * Referenced by: '<Root>/r_in'
                                        */
  real_T u_newModel_P1;                /* Expression: width
                                        * Referenced by: '<Root>/u_newModel'
                                        */
  real_T u_newModel_P2;                /* Expression: dtype
                                        * Referenced by: '<Root>/u_newModel'
                                        */
  real_T u_newModel_P3;                /* Expression: portnum
                                        * Referenced by: '<Root>/u_newModel'
                                        */
  real_T u_newModel_P4;                /* Expression: stime
                                        * Referenced by: '<Root>/u_newModel'
                                        */
  real_T u_newModel_P5;                /* Expression: stype
                                        * Referenced by: '<Root>/u_newModel'
                                        */
  real_T u_newModel_P6;                /* Expression: btype
                                        * Referenced by: '<Root>/u_newModel'
                                        */
  ...
  real_T v_in_P6;                      /* Expression: btype
                                        * Referenced by: '<Root>/v_in'
                                        */
  real_T r_newModel_P1;                /* Expression: width
                                        * Referenced by: '<Root>/r_newModel'
                                        */
  real_T r_newModel_P2;                /* Expression: dtype
                                        * Referenced by: '<Root>/r_newModel'
                                        */
  real_T r_newModel_P3;                /* Expression: portnum
                                        * Referenced by: '<Root>/r_newModel'
                                        */
  real_T r_newModel_P4;                /* Expression: stime
                                        * Referenced by: '<Root>/r_newModel'
                                        */
  real_T r_newModel_P5;                /* Expression: stype
                                        * Referenced by: '<Root>/r_newModel'
                                        */
  real_T r_newModel_P6;                /* Expression: btype
                                        * Referenced by: '<Root>/r_newModel'
                                        */
  ...
  real_T u_dot_imu_P6;                 /* Expression: btype
                                        * Referenced by: '<Root>/u_dot_imu'
                                        */
  real_T psi_newModel1_P1;             /* Expression: width
                                        * Referenced by: '<Root>/psi_newModel1'
                                        */
  real_T psi_newModel1_P2;             /* Expression: dtype
                                        * Referenced by: '<Root>/psi_newModel1'
                                        */
  real_T psi_newModel1_P3;             /* Expression: portnum
                                        * Referenced by: '<Root>/psi_newModel1'
                                        */
  real_T psi_newModel1_P4;             /* Expression: stime
                                        * Referenced by: '<Root>/psi_newModel1'
                                        */
  real_T psi_newModel1_P5;             /* Expression: stype
                                        * Referenced by: '<Root>/psi_newModel1'
                                        */
  real_T psi_newModel1_P6;             /* Expression: btype
                                        * Referenced by: '<Root>/psi_newModel1'
                                        */
  real_T x_newModel1_P1;               /* Expression: width
                                        * Referenced by: '<Root>/x_newModel1'
                                        */
  real_T x_newModel1_P2;               /* Expression: dtype
                                        * Referenced by: '<Root>/x_newModel1'
                                        */
  real_T x_newModel1_P3;               /* Expression: portnum
                                        * Referenced by: '<Root>/x_newModel1'
                                        */
  real_T x_newModel1_P4;               /* Expression: stime
                                        * Referenced by: '<Root>/x_newModel1'
                                        */
  real_T x_newModel1_P5;               /* Expression: stype
                                        * Referenced by: '<Root>/x_newModel1'
                                        */
  real_T x_newModel1_P6;               /* Expression: btype
                                        * Referenced by: '<Root>/x_newModel1'
                                        */
  real_T y_newModel1_P1;               /* Expression: width
                                        * Referenced by: '<Root>/y_newModel1'
                                        */
  real_T y_newModel1_P2;               /* Expression: dtype
                                        * Referenced by: '<Root>/y_newModel1'
                                        */
  real_T y_newModel1_P3;               /* Expression: portnum
                                        * Referenced by: '<Root>/y_newModel1'
                                        */
  real_T y_newModel1_P4;               /* Expression: stime
                                        * Referenced by: '<Root>/y_newModel1'
                                        */
  real_T y_newModel1_P5;               /* Expression: stype
                                        * Referenced by: '<Root>/y_newModel1'
                                        */
  real_T y_newModel1_P6;               /* Expression: btype
                                        * Referenced by: '<Root>/y_newModel1'
                                        */
...
extern P_ctrl_case_b_T ctrl_case_b_P;

/* Block signals (auto storage) */
extern B_ctrl_case_b_T ctrl_case_b_B;

/* Continuous states (auto storage) */
extern X_ctrl_case_b_T ctrl_case_b_X;

/* Block states (auto storage) */
extern DW_ctrl_case_b_T ctrl_case_b_DW;

/* External data declarations for dependent source files */
extern const real_T ctrl_case_b_RGND;  /* real_T ground */

/* Model entry point functions */
extern void ctrl_case_b_initialize(void);
extern void ctrl_case_b_output(void);
extern void ctrl_case_b_update(void);
extern void ctrl_case_b_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern ctrl_case_b_rtModel *ctrl_case_b(void);
...
extern RT_MODEL_ctrl_case_b_T *const ctrl_case_b_M;
 ...
 *
 * '<Root>' : 'ctrl_case_b'
 * '<S1>'   : 'ctrl_case_b/MATLAB Function'
 * '<S2>'   : 'ctrl_case_b/MATLAB Function1'
 * '<S3>'   : 'ctrl_case_b/MATLAB Function2'
 * '<S4>'   : 'ctrl_case_b/Noise generator'
 * '<S5>'   : 'ctrl_case_b/Subsystem'
 * '<S6>'   : 'ctrl_case_b/SurgeObserver '
 * '<S7>'   : 'ctrl_case_b/joystick'
 * '<S8>'   : 'ctrl_case_b/tau to CSE mocell (only use for HIL testing)'
 * '<S9>'   : 'ctrl_case_b/Noise generator/Downsample	signal'
 * '<S10>'  : 'ctrl_case_b/Noise generator/Sample & hold'
 * '<S11>'  : 'ctrl_case_b/Noise generator/noise generator'
 * '<S12>'  : 'ctrl_case_b/Noise generator/Downsample	signal/MATLAB Function'
 * '<S13>'  : 'ctrl_case_b/Noise generator/Sample & hold/MATLAB Function1'
 * '<S14>'  : 'ctrl_case_b/Noise generator/noise generator/Band-limited white noise psi'
 * '<S15>'  : 'ctrl_case_b/Noise generator/noise generator/Band-limited white noise x'
 * '<S16>'  : 'ctrl_case_b/Noise generator/noise generator/Band-limited white noise y'
 * '<S17>'  : 'ctrl_case_b/Subsystem/kinematics'
 * '<S18>'  : 'ctrl_case_b/Subsystem/kinetics'
 * '<S19>'  : 'ctrl_case_b/SurgeObserver /Integration block '
 * '<S20>'  : 'ctrl_case_b/SurgeObserver /the rest '
 * '<S21>'  : 'ctrl_case_b/joystick/MATLAB Function'
 */
#endif                                 /* RTW_HEADER_ctrl_case_b_h_ */
...
P_ctrl_case_b_T rtParameter[NUMST+!TID01EQ];
P_ctrl_case_b_T *param_lookup[NUMST][2] = {
...
extern int tid;
extern P_ctrl_case_b_T* param_lookup[NUMST][2];

#else

extern P_ctrl_case_b_T rtParameter[];

#endif
#endif

#ifdef MULTITASKING
#define ctrl_case_b_P                  (*param_lookup[tid][READSIDE])
#else
#define ctrl_case_b_P                  rtParameter[READSIDE]
#endif
#endif
#endif
