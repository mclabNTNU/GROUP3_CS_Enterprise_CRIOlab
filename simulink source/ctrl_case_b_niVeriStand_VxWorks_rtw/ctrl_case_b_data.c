...
# define ctrl_case_b_P                 ctrl_case_b_P DataSection(".NIVS.defaultparams")
#endif
...
NI_ParamSizeWidth P_ctrl_case_b_T_sizes[] DataSection(".NIVS.defaultparamsizes")
  = {
  { sizeof(P_ctrl_case_b_T), 1 },
