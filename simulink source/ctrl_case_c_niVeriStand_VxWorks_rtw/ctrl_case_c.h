...
#ifndef RTW_HEADER_ctrl_case_c_h_
#define RTW_HEADER_ctrl_case_c_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef ctrl_case_c_COMMON_INCLUDES_
# define ctrl_case_c_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "zero_crossing_types.h"
#include "simstruc.h"
#include "fixedpoint.h"
#include "rt_logging.h"
#endif                                 /* ctrl_case_c_COMMON_INCLUDES_ */

#include "ctrl_case_c_types.h"
...
#define ctrl_case_c_rtModel            RT_MODEL_ctrl_case_c_T
...
typedef struct {
  ...
  uint8_T L2_continuous_DWORK2[12];    /* '<S3>/L2_continuous' */
  uint8_T PosXRight_DWORK2[12];        /* '<S3>/PosXRight' */
  uint8_T PosYRight_DWORK2[12];        /* '<S3>/PosYRight' */
  uint8_T R2_continuous_DWORK2[12];    /* '<S3>/R2_continuous' */
  uint8_T PosXLeft_DWORK2[12];         /* '<S3>/PosXLeft' */
  uint8_T PosYLeft_DWORK2[12];         /* '<S3>/PosYLeft' */
  uint8_T L1_DWORK2[12];               /* '<S3>/L1' */
  uint8_T R1_DWORK2[12];               /* '<S3>/R1' */
  uint8_T ArrowDown_DWORK2[12];        /* '<S3>/ArrowDown' */
  uint8_T ArrowUp_DWORK2[12];          /* '<S3>/ArrowUp' */
  uint8_T ArrowLeft_DWORK2[12];        /* '<S3>/ArrowLeft' */
  uint8_T ArrowRight_DWORK2[12];       /* '<S3>/ArrowRight' */
...
#define rtB                            ctrl_case_c_B
#define BlockIO                        B_ctrl_case_c_T
#define rtX                            ctrl_case_c_X
#define ContinuousStates               X_ctrl_case_c_T
#define rtXdot                         ctrl_case_c_XDot
#define StateDerivatives               XDot_ctrl_case_c_T
#define tXdis                          ctrl_case_c_XDis
#define StateDisabled                  XDis_ctrl_case_c_T
#define rtP                            ctrl_case_c_P
#define Parameters                     P_ctrl_case_c_T
#define rtDWork                        ctrl_case_c_DW
#define D_Work                         DW_ctrl_case_c_T

/* Parameters (auto storage) */
struct P_ctrl_case_c_T_ {
  ...
  real_T psi_in_P6;                    /* Expression: btype
                                        * Referenced by: '<Root>/psi_in'
                                        */
  real_T Constant_Value[3];            /* Expression: [1 1 1]
                                        * Referenced by: '<S1>/Constant'
                                        */
  real_T Constant1_Value[3];           /* Expression: [2 2 2]
                                        * Referenced by: '<S1>/Constant1'
                                        */
  real_T Constant2_Value[3];           /* Expression: [1 1 1]
...
extern P_ctrl_case_c_T ctrl_case_c_P;

/* Block signals (auto storage) */
extern B_ctrl_case_c_T ctrl_case_c_B;

/* Continuous states (auto storage) */
extern X_ctrl_case_c_T ctrl_case_c_X;

/* Block states (auto storage) */
extern DW_ctrl_case_c_T ctrl_case_c_DW;

/* Model entry point functions */
extern void ctrl_case_c_initialize(void);
extern void ctrl_case_c_output(void);
extern void ctrl_case_c_update(void);
extern void ctrl_case_c_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern ctrl_case_c_rtModel *ctrl_case_c(void);
...
extern RT_MODEL_ctrl_case_c_T *const ctrl_case_c_M;
 ...
 *
 * '<Root>' : 'ctrl_case_c'
 * '<S1>'   : 'ctrl_case_c/DP Observer '
 * '<S2>'   : 'ctrl_case_c/Noise generator'
 * '<S3>'   : 'ctrl_case_c/joystick'
 * '<S4>'   : 'ctrl_case_c/tau to CSE mocell (only use for HIL testing)'
 * '<S5>'   : 'ctrl_case_c/DP Observer /Observer '
 * '<S6>'   : 'ctrl_case_c/Noise generator/Downsample	signal'
 * '<S7>'   : 'ctrl_case_c/Noise generator/Sample & hold'
 * '<S8>'   : 'ctrl_case_c/Noise generator/noise generator'
 * '<S9>'   : 'ctrl_case_c/Noise generator/Downsample	signal/MATLAB Function'
 * '<S10>'  : 'ctrl_case_c/Noise generator/Sample & hold/MATLAB Function1'
 * '<S11>'  : 'ctrl_case_c/Noise generator/noise generator/Band-limited white noise psi'
 * '<S12>'  : 'ctrl_case_c/Noise generator/noise generator/Band-limited white noise x'
 * '<S13>'  : 'ctrl_case_c/Noise generator/noise generator/Band-limited white noise y'
 */
#endif                                 /* RTW_HEADER_ctrl_case_c_h_ */
...
P_ctrl_case_c_T rtParameter[NUMST+!TID01EQ];
P_ctrl_case_c_T *param_lookup[NUMST][2] = {
...
extern int tid;
extern P_ctrl_case_c_T* param_lookup[NUMST][2];

#else

extern P_ctrl_case_c_T rtParameter[];

#endif
#endif

#ifdef MULTITASKING
#define ctrl_case_c_P                  (*param_lookup[tid][READSIDE])
#else
#define ctrl_case_c_P                  rtParameter[READSIDE]
#endif
#endif
#endif
