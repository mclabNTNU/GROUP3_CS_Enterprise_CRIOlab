...
#
# File    : ctrl_case_c.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= ctrl_case_c
MODULES         		:= NIVeriStand_main.c ctrl_case_c_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE        		:= ctrl_case_c.mk
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\MCLab\DOCUME~1\GitHub\GROUP3~1\SIMULI~1\ctrl_case_c_niVeriStand_VxWorks_rtw
