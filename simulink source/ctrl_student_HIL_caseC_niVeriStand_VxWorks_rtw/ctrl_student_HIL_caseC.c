 ...
 * C source code generated on : Wed Mar 22 12:28:42 2017
 *
...
const real_T ctrl_student_HIL_caseC_RGND = 0.0;/* real_T ground */
...
void ctrl_student_HIL_caseC_output(void)
{
  ...
  /* Sum: '<Root>/Sum' */
  rtb_Sum_d = ctrl_student_HIL_caseC_B.L2_continuous -
  ...
  if (ctrl_student_HIL_caseC_B.count == 0.0) {
    /* '<S10>:1:4' */
    /* '<S10>:1:5' */
    ctrl_student_HIL_caseC_B.output[0] = sqrt(ctrl_student_HIL_caseC_B.noisepos /
      ctrl_student_HIL_caseC_P.Stepsize_Value) *
      ctrl_student_HIL_caseC_B.WhiteNoise + ctrl_student_HIL_caseC_B.x_in;
    ctrl_student_HIL_caseC_B.output[1] = sqrt(ctrl_student_HIL_caseC_B.noisepos /
      ctrl_student_HIL_caseC_P.Stepsize_Value) *
      ctrl_student_HIL_caseC_B.WhiteNoise_e + ctrl_student_HIL_caseC_B.y_in;
    ctrl_student_HIL_caseC_B.output[2] = sqrt(ctrl_student_HIL_caseC_B.noisehead
      / ctrl_student_HIL_caseC_P.Stepsize_Value) *
      ctrl_student_HIL_caseC_B.WhiteNoise_m + rtb_Sum_d;
  } else {
    /* '<S10>:1:7' */
  ...
  /* Switch: '<S2>/Switch' */
  if (ctrl_student_HIL_caseC_B.enablenoise != 0.0) {
    ...
    ctrl_student_HIL_caseC_B.Switch[2] = rtb_Sum_d;
  }
  ...
  ctrl_student_HIL_caseC_B.Integrator[0] =
    ctrl_student_HIL_caseC_X.Integrator_CSTATE[0];
  ctrl_student_HIL_caseC_B.Integrator[1] =
    ctrl_student_HIL_caseC_X.Integrator_CSTATE[1];
  ctrl_student_HIL_caseC_B.Integrator[2] =
  ...
  if (rtmIsMajorTimeStep(ctrl_student_HIL_caseC_M)) {
    /* Memory: '<S1>/Memory4' */
    ctrl_student_HIL_caseC_B.Memory4[0] =
      ctrl_student_HIL_caseC_DW.Memory4_PreviousInput[0];
    ctrl_student_HIL_caseC_B.Memory4[1] =
      ctrl_student_HIL_caseC_DW.Memory4_PreviousInput[1];
    ctrl_student_HIL_caseC_B.Memory4[2] =
      ctrl_student_HIL_caseC_DW.Memory4_PreviousInput[2];

    /* Memory: '<S1>/Memory3' */
    ctrl_student_HIL_caseC_B.Memory3[0] =
      ctrl_student_HIL_caseC_DW.Memory3_PreviousInput[0];
    ctrl_student_HIL_caseC_B.Memory3[1] =
      ctrl_student_HIL_caseC_DW.Memory3_PreviousInput[1];
    ctrl_student_HIL_caseC_B.Memory3[2] =
      ctrl_student_HIL_caseC_DW.Memory3_PreviousInput[2];

    /* Memory: '<S1>/Memory2' */
    ctrl_student_HIL_caseC_B.Memory2[0] =
      ctrl_student_HIL_caseC_DW.Memory2_PreviousInput[0];
    ctrl_student_HIL_caseC_B.Memory2[1] =
      ctrl_student_HIL_caseC_DW.Memory2_PreviousInput[1];
    ctrl_student_HIL_caseC_B.Memory2[2] =
      ctrl_student_HIL_caseC_DW.Memory2_PreviousInput[2];
  }
  ...
  L1[0] = ctrl_student_HIL_caseC_B.L1_diag[0];
  L1[4] = ctrl_student_HIL_caseC_B.L1_diag[1];
  L1[8] = ctrl_student_HIL_caseC_B.L1_diag[2];

  /* '<S5>:1:9' */
  L2[0] = ctrl_student_HIL_caseC_B.L2_diag[0];
  L2[4] = ctrl_student_HIL_caseC_B.L2_diag[1];
  L2[8] = ctrl_student_HIL_caseC_B.L2_diag[2];

  /* '<S5>:1:10' */
  L3[0] = ctrl_student_HIL_caseC_B.L3_diag[0];
  L3[4] = ctrl_student_HIL_caseC_B.L3_diag[1];
  L3[8] = ctrl_student_HIL_caseC_B.L3_diag[2];

  /*  The total damping matrix from the handbook page 53 */
  /* '<S5>:1:19' */
  rtb_Sum_d = ctrl_student_HIL_caseC_B.Switch[0] -
    ctrl_student_HIL_caseC_B.Memory4[0];
  eta_bar_idx_1 = ctrl_student_HIL_caseC_B.Switch[1] -
    ctrl_student_HIL_caseC_B.Memory4[1];
  eta_bar_idx_2 = ctrl_student_HIL_caseC_B.Switch[2] -
    ctrl_student_HIL_caseC_B.Memory4[2];

  /* '<S5>:1:20' */
  ctrl_student_HIL_caseC_B.x_bar = rtb_Sum_d;

  /* '<S5>:1:21' */
  ctrl_student_HIL_caseC_B.y_bar = eta_bar_idx_1;

  /* '<S5>:1:22' */
  ctrl_student_HIL_caseC_B.psi_bar = eta_bar_idx_2;

  /* '<S5>:1:23' */
  /* '<S5>:1:24' */
  R[0] = cos(ctrl_student_HIL_caseC_B.Switch[2]);
  R[3] = sin(ctrl_student_HIL_caseC_B.Switch[2]);
  R[6] = 0.0;
  R[1] = -sin(ctrl_student_HIL_caseC_B.Switch[2]);
  R[4] = cos(ctrl_student_HIL_caseC_B.Switch[2]);
  R[7] = 0.0;
  R[2] = 0.0;
  R[5] = 0.0;
  R[8] = 1.0;
  ...
  /* '<S5>:1:29' */
  for (i = 0; i < 3; i++) {
    R_0[i] = R[i + 6] * ctrl_student_HIL_caseC_B.Memory3[2] + (R[i + 3] *
      ctrl_student_HIL_caseC_B.Memory3[1] + R[i] *
      ctrl_student_HIL_caseC_B.Memory3[0]);
  }
  ...
  ctrl_student_HIL_caseC_B.eta_hat_dot[0] = R_0[0] + L1_0[0];
  ctrl_student_HIL_caseC_B.eta_hat_dot[1] = R_0[1] + L1_0[1];
  ctrl_student_HIL_caseC_B.eta_hat_dot[2] = R_0[2] + L1_0[2];

  /* '<S5>:1:31' */
  for (i = 0; i < 3; i++) {
    ctrl_student_HIL_caseC_B.b_hat_dot[i] = ((L3[i + 3] * eta_bar_idx_1 + L3[i] *
      rtb_Sum_d) + L3[i + 6] * eta_bar_idx_2) + ctrl_student_HIL_caseC_B.b;
  }

  for (i = 0; i < 3; i++) {
    L1_0[i] = b_a[i + 6] * ctrl_student_HIL_caseC_B.Memory3[2] + (b_a[i + 3] *
      ctrl_student_HIL_caseC_B.Memory3[1] + b_a[i] *
      ctrl_student_HIL_caseC_B.Memory3[0]);
  }

  for (i = 0; i < 3; i++) {
    R_0[i] = R[3 * i + 2] * ctrl_student_HIL_caseC_B.Memory2[2] + (R[3 * i + 1] *
      ctrl_student_HIL_caseC_B.Memory2[1] + R[3 * i] *
      ctrl_student_HIL_caseC_B.Memory2[0]);
  }
  ...
  for (i = 0; i < 3; i++) {
    b_a_0[i] = ((L1[i + 3] * eta_bar_idx_1 + L1[i] * rtb_Sum_d) + L1[i + 6] *
                eta_bar_idx_2) + ((L1_0[i] + R_0[i]) +
      ctrl_student_HIL_caseC_B.PosXRight);
  }

  for (i = 0; i < 3; i++) {
    ctrl_student_HIL_caseC_B.nu_hat_dot[i] = 0.0;
    ctrl_student_HIL_caseC_B.nu_hat_dot[i] += a[i] * b_a_0[0];
    ctrl_student_HIL_caseC_B.nu_hat_dot[i] += a[i + 3] * b_a_0[1];
    ctrl_student_HIL_caseC_B.nu_hat_dot[i] += a[i + 6] * b_a_0[2];
  }
...
void ctrl_student_HIL_caseC_derivatives(void)
{
  ...
  _rtXdot->Integrator_CSTATE[0] = ctrl_student_HIL_caseC_B.eta_hat_dot[0];
  _rtXdot->Integrator_CSTATE[1] = ctrl_student_HIL_caseC_B.eta_hat_dot[1];
  _rtXdot->Integrator_CSTATE[2] = ctrl_student_HIL_caseC_B.eta_hat_dot[2];

  /* Derivatives for Integrator: '<S1>/Integrator1' */
  _rtXdot->Integrator1_CSTATE[0] = ctrl_student_HIL_caseC_B.nu_hat_dot[0];
  _rtXdot->Integrator1_CSTATE[1] = ctrl_student_HIL_caseC_B.nu_hat_dot[1];
  _rtXdot->Integrator1_CSTATE[2] = ctrl_student_HIL_caseC_B.nu_hat_dot[2];

  /* Derivatives for Integrator: '<S1>/Integrator2' */
  _rtXdot->Integrator2_CSTATE[0] = ctrl_student_HIL_caseC_B.b_hat_dot[0];
  _rtXdot->Integrator2_CSTATE[1] = ctrl_student_HIL_caseC_B.b_hat_dot[1];
  _rtXdot->Integrator2_CSTATE[2] = ctrl_student_HIL_caseC_B.b_hat_dot[2];
}
...
{
  {
    ...
    ctrl_student_HIL_caseC_X.Integrator1_CSTATE[0] =
      ctrl_student_HIL_caseC_P.Integrator1_IC;
    ctrl_student_HIL_caseC_X.Integrator1_CSTATE[1] =
      ctrl_student_HIL_caseC_P.Integrator1_IC;
    ctrl_student_HIL_caseC_X.Integrator1_CSTATE[2] =
      ctrl_student_HIL_caseC_P.Integrator1_IC;
    ...
    ctrl_student_HIL_caseC_DW.Memory4_PreviousInput[0] =
      ctrl_student_HIL_caseC_P.Memory4_X0[0];
    ctrl_student_HIL_caseC_DW.Memory4_PreviousInput[1] =
      ctrl_student_HIL_caseC_P.Memory4_X0[1];
    ctrl_student_HIL_caseC_DW.Memory4_PreviousInput[2] =
      ctrl_student_HIL_caseC_P.Memory4_X0[2];

    /* InitializeConditions for Memory: '<S1>/Memory3' */
    ctrl_student_HIL_caseC_DW.Memory3_PreviousInput[0] =
      ctrl_student_HIL_caseC_P.Memory3_X0[0];
    ctrl_student_HIL_caseC_DW.Memory3_PreviousInput[1] =
      ctrl_student_HIL_caseC_P.Memory3_X0[1];
    ctrl_student_HIL_caseC_DW.Memory3_PreviousInput[2] =
      ctrl_student_HIL_caseC_P.Memory3_X0[2];

    /* InitializeConditions for Memory: '<S1>/Memory2' */
    ctrl_student_HIL_caseC_DW.Memory2_PreviousInput[0] =
      ctrl_student_HIL_caseC_P.Memory2_X0[0];
    ctrl_student_HIL_caseC_DW.Memory2_PreviousInput[1] =
      ctrl_student_HIL_caseC_P.Memory2_X0[1];
    ctrl_student_HIL_caseC_DW.Memory2_PreviousInput[2] =
      ctrl_student_HIL_caseC_P.Memory2_X0[2];

    /* InitializeConditions for Integrator: '<S1>/Integrator2' */
    ctrl_student_HIL_caseC_X.Integrator2_CSTATE[0] =
      ctrl_student_HIL_caseC_P.Integrator2_IC;
    ctrl_student_HIL_caseC_X.Integrator2_CSTATE[1] =
      ctrl_student_HIL_caseC_P.Integrator2_IC;
    ctrl_student_HIL_caseC_X.Integrator2_CSTATE[2] =
      ctrl_student_HIL_caseC_P.Integrator2_IC;
...
RT_MODEL_ctrl_student_HIL_cas_T *ctrl_student_HIL_caseC(void)
{
  ...
  ctrl_student_HIL_caseC_M->Sizes.numBlocks = (78);/* Number of blocks */
  ctrl_student_HIL_caseC_M->Sizes.numBlockIO = (43);/* Number of block outputs */
  ctrl_student_HIL_caseC_M->Sizes.numBlockPrms = (287);/* Sum of parameter "widths" */
...
void SetExternalInputs(double* data, int* TaskSampleHit)
{
  ...
  // noise pos
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_B.noisepos, 0, data[index++],
      0, 0);
  } else {
    index += 1;
  }
  ...
  // noise head
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_B.noisehead, 0, data[index++],
      0, 0);
  } else {
    index += 1;
  }
  ...
  // enable noise
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_B.enablenoise, 0, data[index
      ++], 0, 0);
  } else {
    index += 1;
  }
  ...
  // DP Observer /L1_diag
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_B.L1_diag, 0, data[index++],
      18, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_B.L1_diag, 1, data[index++],
      18, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_B.L1_diag, 2, data[index++],
      18, 0);
  } else {
    index += 3;
  }
  ...
  // DP Observer /L2_diag
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_B.L2_diag, 0, data[index++],
      18, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_B.L2_diag, 1, data[index++],
      18, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_B.L2_diag, 2, data[index++],
      18, 0);
  } else {
    index += 3;
  }
  ...
  // DP Observer /L3_diag
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_B.L3_diag, 0, data[index++],
      18, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_B.L3_diag, 1, data[index++],
      18, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_B.L3_diag, 2, data[index++],
      18, 0);
  } else {
    index += 3;
  }
  ...
  // DP Observer /b
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_B.b, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }
...
void SetExternalOutputs(double* data, int* TaskSampleHit)
{
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_B.Switch,0,17,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_B.Switch,2,17,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_B.Switch,1,17,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_B.Integrator,0,17,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_B.Integrator,2,17,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_B.Integrator,1,17,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_B.Integrator1,2,17,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_B.Integrator1,0,17,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_B.Integrator1,1,17,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_student_HIL_caseC_B.y_bar,
      0,0,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_B.psi_bar,0,0,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_student_HIL_caseC_B.x_bar,
      0,0,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[1]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType((real_T*)
      &ctrl_student_HIL_caseC_RGND,0,0,0);
  } else {
    index += 1;
  }
...
int NI_InitExternalOutputs()
{
  ...
  // DP Observer /y_bar: Virtual Signal # 0
  ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_student_HIL_caseC_B.y_bar,0,
    0,0);

  // DP Observer /psi_bar: Virtual Signal # 0
  ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_student_HIL_caseC_B.psi_bar,
    0,0,0);

  // DP Observer /x_bar: Virtual Signal # 0
  ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_student_HIL_caseC_B.x_bar,0,
    0,0);
...
{
  { 0, "ctrl_student_hil_casec/Constant4/Value", offsetof
    (P_ctrl_student_HIL_caseC_T, Constant4_Value), 29, 1, 2, 0, 0 },

  { 1, "ctrl_student_hil_casec/Noise generator/Step size/Value", offsetof
    (P_ctrl_student_HIL_caseC_T, Stepsize_Value), 29, 1, 2, 2, 0 },

  { 2, "ctrl_student_hil_casec/Noise generator/Downsamplesignal/counter/X0",
    offsetof(P_ctrl_student_HIL_caseC_T, counter_X0), 29, 1, 2, 4, 0 },

  { 3,
    "ctrl_student_hil_casec/Noise generator/noise generator/Band-limited white noise x/White Noise/Mean",
    offsetof(P_ctrl_student_HIL_caseC_T, WhiteNoise_Mean), 29, 1, 2, 6, 0 },

  { 4,
    "ctrl_student_hil_casec/Noise generator/noise generator/Band-limited white noise x/White Noise/StdDev",
    offsetof(P_ctrl_student_HIL_caseC_T, WhiteNoise_StdDev), 29, 1, 2, 8, 0 },

  { 5,
    "ctrl_student_hil_casec/Noise generator/noise generator/Band-limited white noise x/White Noise/Seed",
    offsetof(P_ctrl_student_HIL_caseC_T, WhiteNoise_Seed), 29, 1, 2, 10, 0 },

  { 6,
    "ctrl_student_hil_casec/Noise generator/noise generator/Band-limited white noise y/White Noise/Mean",
    offsetof(P_ctrl_student_HIL_caseC_T, WhiteNoise_Mean_h), 29, 1, 2, 12, 0 },

  { 7,
    "ctrl_student_hil_casec/Noise generator/noise generator/Band-limited white noise y/White Noise/StdDev",
    offsetof(P_ctrl_student_HIL_caseC_T, WhiteNoise_StdDev_d), 29, 1, 2, 14, 0 },

  { 8,
    "ctrl_student_hil_casec/Noise generator/noise generator/Band-limited white noise y/White Noise/Seed",
    offsetof(P_ctrl_student_HIL_caseC_T, WhiteNoise_Seed_b), 29, 1, 2, 16, 0 },

  { 9,
    "ctrl_student_hil_casec/Noise generator/noise generator/Band-limited white noise psi/White Noise/Mean",
    offsetof(P_ctrl_student_HIL_caseC_T, WhiteNoise_Mean_f), 29, 1, 2, 18, 0 },

  { 10,
    "ctrl_student_hil_casec/Noise generator/noise generator/Band-limited white noise psi/White Noise/StdDev",
    offsetof(P_ctrl_student_HIL_caseC_T, WhiteNoise_StdDev_g), 29, 1, 2, 20, 0 },

  { 11,
    "ctrl_student_hil_casec/Noise generator/noise generator/Band-limited white noise psi/White Noise/Seed",
    offsetof(P_ctrl_student_HIL_caseC_T, WhiteNoise_Seed_l), 29, 1, 2, 22, 0 },

  { 12, "ctrl_student_hil_casec/Noise generator/Sample & hold/Hold/X0", offsetof
    (P_ctrl_student_HIL_caseC_T, Hold_X0), 29, 1, 2, 24, 0 },

  { 13, "ctrl_student_hil_casec/DP Observer /Integrator/InitialCondition",
    offsetof(P_ctrl_student_HIL_caseC_T, Integrator_IC), 29, 1, 2, 26, 0 },

  { 14, "ctrl_student_hil_casec/DP Observer /Integrator1/InitialCondition",
    offsetof(P_ctrl_student_HIL_caseC_T, Integrator1_IC), 29, 1, 2, 28, 0 },

  { 15, "ctrl_student_hil_casec/DP Observer /Memory4/X0", offsetof
    (P_ctrl_student_HIL_caseC_T, Memory4_X0), 18, 3, 2, 30, 0 },

  { 16, "ctrl_student_hil_casec/DP Observer /Memory3/X0", offsetof
    (P_ctrl_student_HIL_caseC_T, Memory3_X0), 18, 3, 2, 32, 0 },

  { 17, "ctrl_student_hil_casec/DP Observer /Memory2/X0", offsetof
    (P_ctrl_student_HIL_caseC_T, Memory2_X0), 18, 3, 2, 34, 0 },

  { 18, "ctrl_student_hil_casec/DP Observer /Integrator2/InitialCondition",
    offsetof(P_ctrl_student_HIL_caseC_T, Integrator2_IC), 29, 1, 2, 36, 0 },

  { 19,
    "ctrl_student_hil_casec/tau to CSE mocell (only use for HIL testing)/Constant2/Value",
    offsetof(P_ctrl_student_HIL_caseC_T, Constant2_Value), 29, 1, 2, 38, 0 },

  { 20,
    "ctrl_student_hil_casec/tau to CSE mocell (only use for HIL testing)/Constant/Value",
    offsetof(P_ctrl_student_HIL_caseC_T, Constant_Value), 29, 1, 2, 40, 0 },

  { 21,
    "ctrl_student_hil_casec/tau to CSE mocell (only use for HIL testing)/Constant1/Value",
    offsetof(P_ctrl_student_HIL_caseC_T, Constant1_Value), 29, 1, 2, 42, 0 },
};
...
{
  { 0, "ctrl_student_hil_casec/noise pos", 0, "", offsetof
    (B_ctrl_student_HIL_caseC_T, noisepos)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1,
    2, 0, 0 },
  ...
  { 3, "ctrl_student_hil_casec/noise head", 0, "", offsetof
    (B_ctrl_student_HIL_caseC_T, noisehead)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1,
    2, 6, 0 },
  ...
  { 5, "ctrl_student_hil_casec/y_in", 0, "", offsetof(B_ctrl_student_HIL_caseC_T,
    y_in)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 10, 0 },

  { 6, "ctrl_student_hil_casec/joystick/L2_continuous", 0, "", offsetof
    (B_ctrl_student_HIL_caseC_T, L2_continuous)+0*sizeof(real_T), BLOCKIO_SIG, 0,
    1, 2, 12, 0 },

  { 7, "ctrl_student_hil_casec/joystick/PosXRight", 0, "", offsetof
    (B_ctrl_student_HIL_caseC_T, PosXRight)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1,
    2, 14, 0 },

  { 8, "ctrl_student_hil_casec/joystick/PosYRight", 0, "", offsetof
    (B_ctrl_student_HIL_caseC_T, PosYRight)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1,
    2, 16, 0 },

  { 9, "ctrl_student_hil_casec/joystick/R2_continuous", 0, "", offsetof
    (B_ctrl_student_HIL_caseC_T, R2_continuous)+0*sizeof(real_T), BLOCKIO_SIG, 0,
    1, 2, 18, 0 },

  { 10, "ctrl_student_hil_casec/joystick/PosXLeft", 0, "", offsetof
    (B_ctrl_student_HIL_caseC_T, PosXLeft)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1,
    2, 20, 0 },

  { 11, "ctrl_student_hil_casec/joystick/PosYLeft", 0, "", offsetof
    (B_ctrl_student_HIL_caseC_T, PosYLeft)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1,
    2, 22, 0 },

  { 12, "ctrl_student_hil_casec/joystick/L1", 0, "", offsetof
    (B_ctrl_student_HIL_caseC_T, L1)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 24,
    0 },

  { 13, "ctrl_student_hil_casec/joystick/R1", 0, "", offsetof
    (B_ctrl_student_HIL_caseC_T, R1)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 26,
    0 },

  { 14, "ctrl_student_hil_casec/joystick/ArrowDown", 0, "", offsetof
    (B_ctrl_student_HIL_caseC_T, ArrowDown)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1,
    2, 28, 0 },

  { 15, "ctrl_student_hil_casec/joystick/ArrowUp", 0, "", offsetof
    (B_ctrl_student_HIL_caseC_T, ArrowUp)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    30, 0 },

  { 16, "ctrl_student_hil_casec/joystick/ArrowLeft", 0, "", offsetof
    (B_ctrl_student_HIL_caseC_T, ArrowLeft)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1,
    2, 32, 0 },

  { 17, "ctrl_student_hil_casec/joystick/ArrowRight", 0, "", offsetof
    (B_ctrl_student_HIL_caseC_T, ArrowRight)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1,
    2, 34, 0 },

  { 18, "ctrl_student_hil_casec/x_in", 0, "", offsetof
    (B_ctrl_student_HIL_caseC_T, x_in)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    36, 0 },

  { 19, "ctrl_student_hil_casec/Noise generator/Sample & hold/Hold", 0, "(1,1)",
    offsetof(B_ctrl_student_HIL_caseC_T, Hold)+0*sizeof(real_T), BLOCKIO_SIG, 17,
    1, 2, 38, 0 },

  { 20, "ctrl_student_hil_casec/Noise generator/Sample & hold/Hold", 0, "(1,2)",
    offsetof(B_ctrl_student_HIL_caseC_T, Hold)+1*sizeof(real_T), BLOCKIO_SIG, 17,
    1, 2, 40, 0 },

  { 21, "ctrl_student_hil_casec/Noise generator/Sample & hold/Hold", 0, "(1,3)",
    offsetof(B_ctrl_student_HIL_caseC_T, Hold)+2*sizeof(real_T), BLOCKIO_SIG, 17,
    1, 2, 42, 0 },

  { 22, "ctrl_student_hil_casec/enable noise", 0, "", offsetof
    (B_ctrl_student_HIL_caseC_T, enablenoise)+0*sizeof(real_T), BLOCKIO_SIG, 0,
    1, 2, 44, 0 },

  { 23, "ctrl_student_hil_casec/Noise generator/Switch", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_caseC_T, Switch)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    46, 0 },

  { 24, "ctrl_student_hil_casec/Noise generator/Switch", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_caseC_T, Switch)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    48, 0 },

  { 25, "ctrl_student_hil_casec/Noise generator/Switch", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_caseC_T, Switch)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    50, 0 },

  { 26, "ctrl_student_hil_casec/r_in", 0, "", offsetof
    (B_ctrl_student_HIL_caseC_T, r_in)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    52, 0 },

  { 27, "ctrl_student_hil_casec/u_in", 0, "", offsetof
    (B_ctrl_student_HIL_caseC_T, u_in)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    54, 0 },

  { 28, "ctrl_student_hil_casec/v_in", 0, "", offsetof
    (B_ctrl_student_HIL_caseC_T, v_in)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    56, 0 },

  { 29, "ctrl_student_hil_casec/DP Observer /Integrator", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_caseC_T, Integrator)+0*sizeof(real_T), BLOCKIO_SIG, 17,
    1, 2, 58, 0 },

  { 30, "ctrl_student_hil_casec/DP Observer /Integrator", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_caseC_T, Integrator)+1*sizeof(real_T), BLOCKIO_SIG, 17,
    1, 2, 60, 0 },

  { 31, "ctrl_student_hil_casec/DP Observer /Integrator", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_caseC_T, Integrator)+2*sizeof(real_T), BLOCKIO_SIG, 17,
    1, 2, 62, 0 },

  { 32, "ctrl_student_hil_casec/DP Observer /L1_diag", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_caseC_T, L1_diag)+0*sizeof(real_T), BLOCKIO_SIG, 18, 1,
    2, 64, 0 },

  { 33, "ctrl_student_hil_casec/DP Observer /L1_diag", 0, "(2,1)", offsetof
    (B_ctrl_student_HIL_caseC_T, L1_diag)+1*sizeof(real_T), BLOCKIO_SIG, 18, 1,
    2, 66, 0 },

  { 34, "ctrl_student_hil_casec/DP Observer /L1_diag", 0, "(3,1)", offsetof
    (B_ctrl_student_HIL_caseC_T, L1_diag)+2*sizeof(real_T), BLOCKIO_SIG, 18, 1,
    2, 68, 0 },

  { 35, "ctrl_student_hil_casec/DP Observer /L2_diag", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_caseC_T, L2_diag)+0*sizeof(real_T), BLOCKIO_SIG, 18, 1,
    2, 70, 0 },

  { 36, "ctrl_student_hil_casec/DP Observer /L2_diag", 0, "(2,1)", offsetof
    (B_ctrl_student_HIL_caseC_T, L2_diag)+1*sizeof(real_T), BLOCKIO_SIG, 18, 1,
    2, 72, 0 },

  { 37, "ctrl_student_hil_casec/DP Observer /L2_diag", 0, "(3,1)", offsetof
    (B_ctrl_student_HIL_caseC_T, L2_diag)+2*sizeof(real_T), BLOCKIO_SIG, 18, 1,
    2, 74, 0 },

  { 38, "ctrl_student_hil_casec/DP Observer /L3_diag", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_caseC_T, L3_diag)+0*sizeof(real_T), BLOCKIO_SIG, 18, 1,
    2, 76, 0 },

  { 39, "ctrl_student_hil_casec/DP Observer /L3_diag", 0, "(2,1)", offsetof
    (B_ctrl_student_HIL_caseC_T, L3_diag)+1*sizeof(real_T), BLOCKIO_SIG, 18, 1,
    2, 78, 0 },

  { 40, "ctrl_student_hil_casec/DP Observer /L3_diag", 0, "(3,1)", offsetof
    (B_ctrl_student_HIL_caseC_T, L3_diag)+2*sizeof(real_T), BLOCKIO_SIG, 18, 1,
    2, 80, 0 },

  { 41, "ctrl_student_hil_casec/DP Observer /Integrator1", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_caseC_T, Integrator1)+0*sizeof(real_T), BLOCKIO_SIG, 17,
    1, 2, 82, 0 },

  { 42, "ctrl_student_hil_casec/DP Observer /Integrator1", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_caseC_T, Integrator1)+1*sizeof(real_T), BLOCKIO_SIG, 17,
    1, 2, 84, 0 },

  { 43, "ctrl_student_hil_casec/DP Observer /Integrator1", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_caseC_T, Integrator1)+2*sizeof(real_T), BLOCKIO_SIG, 17,
    1, 2, 86, 0 },

  { 44, "ctrl_student_hil_casec/DP Observer /b", 0, "", offsetof
    (B_ctrl_student_HIL_caseC_T, b)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 88,
    0 },

  { 45, "ctrl_student_hil_casec/DP Observer /Memory4", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_caseC_T, Memory4)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1,
    2, 90, 0 },

  { 46, "ctrl_student_hil_casec/DP Observer /Memory4", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_caseC_T, Memory4)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1,
    2, 92, 0 },

  { 47, "ctrl_student_hil_casec/DP Observer /Memory4", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_caseC_T, Memory4)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1,
    2, 94, 0 },

  { 48, "ctrl_student_hil_casec/DP Observer /Memory3", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_caseC_T, Memory3)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1,
    2, 96, 0 },

  { 49, "ctrl_student_hil_casec/DP Observer /Memory3", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_caseC_T, Memory3)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1,
    2, 98, 0 },

  { 50, "ctrl_student_hil_casec/DP Observer /Memory3", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_caseC_T, Memory3)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1,
    2, 100, 0 },

  { 51, "ctrl_student_hil_casec/DP Observer /Memory2", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_caseC_T, Memory2)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1,
    2, 102, 0 },

  { 52, "ctrl_student_hil_casec/DP Observer /Memory2", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_caseC_T, Memory2)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1,
    2, 104, 0 },

  { 53, "ctrl_student_hil_casec/DP Observer /Memory2", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_caseC_T, Memory2)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1,
    2, 106, 0 },

  { 54, "ctrl_student_hil_casec/DP Observer /Integrator2", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_caseC_T, Integrator2)+0*sizeof(real_T), BLOCKIO_SIG, 17,
    1, 2, 108, 0 },

  { 55, "ctrl_student_hil_casec/DP Observer /Integrator2", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_caseC_T, Integrator2)+1*sizeof(real_T), BLOCKIO_SIG, 17,
    1, 2, 110, 0 },

  { 56, "ctrl_student_hil_casec/DP Observer /Integrator2", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_caseC_T, Integrator2)+2*sizeof(real_T), BLOCKIO_SIG, 17,
    1, 2, 112, 0 },
  ...
  { 61, "ctrl_student_hil_casec/DP Observer /Observer", 0, "eta_hat_dot(1,1)",
    offsetof(B_ctrl_student_HIL_caseC_T, eta_hat_dot)+0*sizeof(real_T),
    BLOCKIO_SIG, 17, 1, 2, 122, 0 },

  { 62, "ctrl_student_hil_casec/DP Observer /Observer", 0, "eta_hat_dot(1,2)",
    offsetof(B_ctrl_student_HIL_caseC_T, eta_hat_dot)+1*sizeof(real_T),
    BLOCKIO_SIG, 17, 1, 2, 124, 0 },

  { 63, "ctrl_student_hil_casec/DP Observer /Observer", 0, "eta_hat_dot(1,3)",
    offsetof(B_ctrl_student_HIL_caseC_T, eta_hat_dot)+2*sizeof(real_T),
    BLOCKIO_SIG, 17, 1, 2, 126, 0 },

  { 64, "ctrl_student_hil_casec/DP Observer /Observer", 1, "nu_hat_dot(1,1)",
    offsetof(B_ctrl_student_HIL_caseC_T, nu_hat_dot)+0*sizeof(real_T),
    BLOCKIO_SIG, 17, 1, 2, 128, 0 },

  { 65, "ctrl_student_hil_casec/DP Observer /Observer", 1, "nu_hat_dot(1,2)",
    offsetof(B_ctrl_student_HIL_caseC_T, nu_hat_dot)+1*sizeof(real_T),
    BLOCKIO_SIG, 17, 1, 2, 130, 0 },

  { 66, "ctrl_student_hil_casec/DP Observer /Observer", 1, "nu_hat_dot(1,3)",
    offsetof(B_ctrl_student_HIL_caseC_T, nu_hat_dot)+2*sizeof(real_T),
    BLOCKIO_SIG, 17, 1, 2, 132, 0 },

  { 67, "ctrl_student_hil_casec/DP Observer /Observer", 2, "b_hat_dot(1,1)",
    offsetof(B_ctrl_student_HIL_caseC_T, b_hat_dot)+0*sizeof(real_T),
    BLOCKIO_SIG, 17, 1, 2, 134, 0 },

  { 68, "ctrl_student_hil_casec/DP Observer /Observer", 2, "b_hat_dot(1,2)",
    offsetof(B_ctrl_student_HIL_caseC_T, b_hat_dot)+1*sizeof(real_T),
    BLOCKIO_SIG, 17, 1, 2, 136, 0 },

  { 69, "ctrl_student_hil_casec/DP Observer /Observer", 2, "b_hat_dot(1,3)",
    offsetof(B_ctrl_student_HIL_caseC_T, b_hat_dot)+2*sizeof(real_T),
    BLOCKIO_SIG, 17, 1, 2, 138, 0 },

  { 70, "ctrl_student_hil_casec/DP Observer /Observer", 3, "x_bar", offsetof
    (B_ctrl_student_HIL_caseC_T, x_bar)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    140, 0 },

  { 71, "ctrl_student_hil_casec/DP Observer /Observer", 4, "y_bar", offsetof
    (B_ctrl_student_HIL_caseC_T, y_bar)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    142, 0 },

  { 72, "ctrl_student_hil_casec/DP Observer /Observer", 5, "psi_bar", offsetof
    (B_ctrl_student_HIL_caseC_T, psi_bar)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    144, 0 },

  { -1, "", -1, "", 0, 0, 0 }
};

static int NI_SigListSize DataSection(".NIVS.siglistsize") = 73;
...
static long NI_ExtListSize DataSection(".NIVS.extlistsize") = 43;
static NI_ExternalIO NI_ExtList[] DataSection(".NIVS.extlist") =
{
  ...
  { 3, "joystick/L2_continuous", 0, EXT_IN, 1, 1, 1 },

  { 4, "joystick/PosXRight", 0, EXT_IN, 1, 1, 1 },

  { 5, "joystick/PosYRight", 1, EXT_IN, 1, 1, 1 },

  { 6, "joystick/R2_continuous", 0, EXT_IN, 1, 1, 1 },
  ...
  { 16, "enable noise", 0, EXT_IN, 1, 1, 1 },

  { 17, "r_in", 1, EXT_IN, 1, 1, 1 },

  { 18, "u_in", 1, EXT_IN, 1, 1, 1 },

  { 19, "v_in", 1, EXT_IN, 1, 1, 1 },

  { 20, "DP Observer /L1_diag", 0, EXT_IN, 3, 3, 1 },

  { 21, "DP Observer /L2_diag ", 0, EXT_IN, 3, 3, 1 },

  { 22, "DP Observer /L3_diag", 0, EXT_IN, 3, 3, 1 },

  { 23, "DP Observer /b", 0, EXT_IN, 1, 1, 1 },
...
static char* NI_CompiledModelVersion = "1.168";
static char* NI_CompiledModelDateTime = "Wed Mar 22 12:28:41 2017";
  ...
  * discStates, long* numClockTicks, char* clockTicksNames, long* clockTicks)
{
  ...
  if (discStates && discStatesNames) {
    ...
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.counter_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.noisepos_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.noisepos_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
    ...
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.NextOutput_c");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.noisehead_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.noisehead_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
    ...
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.Hold_PreviousInput, 0, 17, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.Hold_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.Hold_PreviousInput, 1, 17, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.Hold_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.Hold_PreviousInput, 2, 17, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.Hold_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.enablenoise_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.enablenoise_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.x_m_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.x_m_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.psi_m_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.psi_m_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.y_m_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.y_m_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
    ...
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.x_hat_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.x_hat_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.L1_diag_DWORK1, 0, 17, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.L1_diag_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.L1_diag_DWORK1, 1, 17, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.L1_diag_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.L1_diag_DWORK1, 2, 17, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.L1_diag_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.psi_hat_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.psi_hat_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.L2_diag_DWORK1, 0, 17, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.L2_diag_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.L2_diag_DWORK1, 1, 17, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.L2_diag_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.L2_diag_DWORK1, 2, 17, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.L2_diag_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.y_hat_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.y_hat_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.L3_diag_DWORK1, 0, 17, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.L3_diag_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.L3_diag_DWORK1, 1, 17, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.L3_diag_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.L3_diag_DWORK1, 2, 17, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.L3_diag_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.r_dot_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.r_dot_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.b_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.b_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.u_dot_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.u_dot_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.v_dot_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.v_dot_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.Memory4_PreviousInput, 0, 17, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.Memory4_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.Memory4_PreviousInput, 1, 17, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.Memory4_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.Memory4_PreviousInput, 2, 17, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.Memory4_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.Memory3_PreviousInput, 0, 17, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.Memory3_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.Memory3_PreviousInput, 1, 17, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.Memory3_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.Memory3_PreviousInput, 2, 17, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.Memory3_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.Memory2_PreviousInput, 0, 17, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.Memory2_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.Memory2_PreviousInput, 1, 17, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.Memory2_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.Memory2_PreviousInput, 2, 17, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.Memory2_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.y_bar_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.y_bar_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.psi_bar_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.psi_bar_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_caseC_DW.x_bar_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_caseC_DW.x_bar_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
    ...
    for (count = 0; count < 23; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_caseC_DW.noisepos_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_student_HIL_caseC_DW.noisepos_DWORK2");
    }

    for (count = 0; count < 23; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_caseC_DW.noisehead_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_student_HIL_caseC_DW.noisehead_DWORK2");
    }
    ...
    for (count = 0; count < 23; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_caseC_DW.enablenoise_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_student_HIL_caseC_DW.enablenoise_DWORK2");
    }

    for (count = 0; count < 23; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_caseC_DW.x_m_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_student_HIL_caseC_DW.x_m_DWORK2");
    }

    for (count = 0; count < 23; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_caseC_DW.psi_m_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_student_HIL_caseC_DW.psi_m_DWORK2");
    }

    for (count = 0; count < 23; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_caseC_DW.y_m_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_student_HIL_caseC_DW.y_m_DWORK2");
    }
    ...
    for (count = 0; count < 23; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_caseC_DW.x_hat_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_student_HIL_caseC_DW.x_hat_DWORK2");
    }

    for (count = 0; count < 23; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_caseC_DW.L1_diag_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_student_HIL_caseC_DW.L1_diag_DWORK2");
    }

    for (count = 0; count < 23; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_caseC_DW.psi_hat_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_student_HIL_caseC_DW.psi_hat_DWORK2");
    }

    for (count = 0; count < 23; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_caseC_DW.L2_diag_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_student_HIL_caseC_DW.L2_diag_DWORK2");
    }

    for (count = 0; count < 23; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_caseC_DW.y_hat_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_student_HIL_caseC_DW.y_hat_DWORK2");
    }

    for (count = 0; count < 23; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_caseC_DW.L3_diag_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_student_HIL_caseC_DW.L3_diag_DWORK2");
    }

    for (count = 0; count < 23; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_caseC_DW.r_dot_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_student_HIL_caseC_DW.r_dot_DWORK2");
    }

    for (count = 0; count < 23; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_caseC_DW.b_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_student_HIL_caseC_DW.b_DWORK2");
    }

    for (count = 0; count < 23; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_caseC_DW.u_dot_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_student_HIL_caseC_DW.u_dot_DWORK2");
    }

    for (count = 0; count < 23; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_caseC_DW.v_dot_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_student_HIL_caseC_DW.v_dot_DWORK2");
    }

    for (count = 0; count < 23; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_caseC_DW.y_bar_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_student_HIL_caseC_DW.y_bar_DWORK2");
    }

    for (count = 0; count < 23; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_caseC_DW.psi_bar_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_student_HIL_caseC_DW.psi_bar_DWORK2");
    }

    for (count = 0; count < 23; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_caseC_DW.x_bar_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_student_HIL_caseC_DW.x_bar_DWORK2");
    }
  ...
  * clockTicks)
{
  ...
  if (discStates) {
    ...
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.counter_PreviousInput, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.noisepos_DWORK1, 0,
      discStates[idx++], 0, 0);
    ...
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.NextOutput_c, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.noisehead_DWORK1, 0,
      discStates[idx++], 0, 0);
    ...
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.Hold_PreviousInput, 2,
      discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.enablenoise_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.x_m_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.psi_m_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.y_m_DWORK1, 0,
      discStates[idx++], 0, 0);
    ...
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.v_in_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.x_hat_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.L1_diag_DWORK1, 0,
      discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.L1_diag_DWORK1, 1,
      discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.L1_diag_DWORK1, 2,
      discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.psi_hat_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.L2_diag_DWORK1, 0,
      discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.L2_diag_DWORK1, 1,
      discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.L2_diag_DWORK1, 2,
      discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.y_hat_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.L3_diag_DWORK1, 0,
      discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.L3_diag_DWORK1, 1,
      discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.L3_diag_DWORK1, 2,
      discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.r_dot_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.b_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.u_dot_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.v_dot_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.Memory4_PreviousInput, 0,
      discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.Memory4_PreviousInput, 1,
      discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.Memory4_PreviousInput, 2,
      discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.Memory3_PreviousInput, 0,
      discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.Memory3_PreviousInput, 1,
      discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.Memory3_PreviousInput, 2,
      discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.Memory2_PreviousInput, 0,
      discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.Memory2_PreviousInput, 1,
      discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.Memory2_PreviousInput, 2,
      discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.y_bar_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.psi_bar_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.x_bar_DWORK1, 0,
      discStates[idx++], 0, 0);
    ...
    NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.RandSeed_c, 0,
      discStates[idx++], 7, 0);
    for (count = 0; count < 23; count++) {
      NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.noisepos_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 23; count++) {
      NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.noisehead_DWORK2, count,
        discStates[idx++], 19, 0);
    }
    ...
    for (count = 0; count < 23; count++) {
      NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.enablenoise_DWORK2,
        count, discStates[idx++], 19, 0);
    }

    for (count = 0; count < 23; count++) {
      NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.x_m_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 23; count++) {
      NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.psi_m_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 23; count++) {
      NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.y_m_DWORK2, count,
        discStates[idx++], 19, 0);
    }
    ...
    for (count = 0; count < 23; count++) {
      NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.x_hat_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 23; count++) {
      NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.L1_diag_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 23; count++) {
      NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.psi_hat_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 23; count++) {
      NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.L2_diag_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 23; count++) {
      NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.y_hat_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 23; count++) {
      NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.L3_diag_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 23; count++) {
      NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.r_dot_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 23; count++) {
      NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.b_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 23; count++) {
      NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.u_dot_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 23; count++) {
      NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.v_dot_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 23; count++) {
      NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.y_bar_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 23; count++) {
      NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.psi_bar_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 23; count++) {
      NIRT_SetValueByDataType(&ctrl_student_HIL_caseC_DW.x_bar_DWORK2, count,
        discStates[idx++], 19, 0);
    }
