...
typedef struct {
  ...
  uint8_T noisepos_DWORK2[23];         /* '<Root>/noise pos' */
  uint8_T noisehead_DWORK2[23];        /* '<Root>/noise head' */
  uint8_T y_in_DWORK2[23];             /* '<Root>/y_in' */
  uint8_T L2_continuous_DWORK2[23];    /* '<S3>/L2_continuous' */
  uint8_T PosXRight_DWORK2[23];        /* '<S3>/PosXRight' */
  uint8_T PosYRight_DWORK2[23];        /* '<S3>/PosYRight' */
  uint8_T R2_continuous_DWORK2[23];    /* '<S3>/R2_continuous' */
  uint8_T PosXLeft_DWORK2[23];         /* '<S3>/PosXLeft' */
  uint8_T PosYLeft_DWORK2[23];         /* '<S3>/PosYLeft' */
  uint8_T L1_DWORK2[23];               /* '<S3>/L1' */
  uint8_T R1_DWORK2[23];               /* '<S3>/R1' */
  uint8_T ArrowDown_DWORK2[23];        /* '<S3>/ArrowDown' */
  uint8_T ArrowUp_DWORK2[23];          /* '<S3>/ArrowUp' */
  uint8_T ArrowLeft_DWORK2[23];        /* '<S3>/ArrowLeft' */
  uint8_T ArrowRight_DWORK2[23];       /* '<S3>/ArrowRight' */
  ...
  uint8_T x_hat_DWORK2[23];            /* '<S1>/x_hat' */
  uint8_T L1_diag_DWORK2[23];          /* '<S1>/L1_diag' */
  uint8_T psi_hat_DWORK2[23];          /* '<S1>/psi_hat' */
  uint8_T L2_diag_DWORK2[23];          /* '<S1>/L2_diag ' */
  uint8_T y_hat_DWORK2[23];            /* '<S1>/y_hat' */
  uint8_T L3_diag_DWORK2[23];          /* '<S1>/L3_diag' */
  uint8_T r_dot_DWORK2[23];            /* '<S1>/r_dot' */
  uint8_T b_DWORK2[23];                /* '<S1>/b' */
  uint8_T u_dot_DWORK2[23];            /* '<S1>/u_dot' */
  uint8_T v_dot_DWORK2[23];            /* '<S1>/v_dot' */
  uint8_T y_bar_DWORK2[23];            /* '<S1>/y_bar' */
  uint8_T psi_bar_DWORK2[23];          /* '<S1>/psi_bar' */
  uint8_T x_bar_DWORK2[23];            /* '<S1>/x_bar' */
  uint8_T X_d_DWORK2[23];              /* '<S4>/X_d' */
  uint8_T N_d_DWORK2[23];              /* '<S4>/N_d' */
  uint8_T Y_d_DWORK2[23];              /* '<S4>/Y_d' */
  uint8_T psi_0_DWORK2[23];            /* '<S4>/psi_0 ' */
  uint8_T x_0_DWORK2[23];              /* '<S4>/x_0' */
  uint8_T y_0_DWORK2[23];              /* '<S4>/y_0' */
  uint8_T integratorresetmodel_DWORK2[23];/* '<S4>/integrator reset model' */
...
extern const real_T ctrl_student_HIL_caseC_RGND;/* real_T ground */
 ...
 * '<S1>'   : 'ctrl_student_HIL_caseC/DP Observer '
 * '<S2>'   : 'ctrl_student_HIL_caseC/Noise generator'
 * '<S3>'   : 'ctrl_student_HIL_caseC/joystick'
 * '<S4>'   : 'ctrl_student_HIL_caseC/tau to CSE mocell (only use for HIL testing)'
 * '<S5>'   : 'ctrl_student_HIL_caseC/DP Observer /Observer '
 * '<S6>'   : 'ctrl_student_HIL_caseC/Noise generator/Downsample	signal'
 * '<S7>'   : 'ctrl_student_HIL_caseC/Noise generator/Sample & hold'
 * '<S8>'   : 'ctrl_student_HIL_caseC/Noise generator/noise generator'
 * '<S9>'   : 'ctrl_student_HIL_caseC/Noise generator/Downsample	signal/MATLAB Function'
 * '<S10>'  : 'ctrl_student_HIL_caseC/Noise generator/Sample & hold/MATLAB Function1'
 * '<S11>'  : 'ctrl_student_HIL_caseC/Noise generator/noise generator/Band-limited white noise psi'
 * '<S12>'  : 'ctrl_student_HIL_caseC/Noise generator/noise generator/Band-limited white noise x'
 * '<S13>'  : 'ctrl_student_HIL_caseC/Noise generator/noise generator/Band-limited white noise y'
 */
