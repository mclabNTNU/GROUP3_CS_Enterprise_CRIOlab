 ...
 * C source code generated on : Fri Mar 03 10:29:36 2017
 *
...
void ctrl_student_HIL_output(void)
{
  ...
  for (i = 0; i < 3; i++) {
    ctrl_student_HIL_B.b_hat_dot[i] = 0.0;
    ctrl_student_HIL_B.b_hat_dot[i] += L3[i] * eta_bar_idx_0;
    ctrl_student_HIL_B.b_hat_dot[i] += L3[i + 3] * eta_bar_idx_1;
    ctrl_student_HIL_B.b_hat_dot[i] += L3[i + 6] * eta_bar_idx_2;
  }
...
RT_MODEL_ctrl_student_HIL_T *ctrl_student_HIL(void)
{
  ...
  ctrl_student_HIL_M->Sizes.numBlocks = (77);/* Number of blocks */
...
static NI_Signal NI_SigList[] DataSection(".NIVS.siglist") =
{
  ...
  { 9, "ctrl_student_hil/Noise generator/Switch", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, Switch)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 18,
    0 },

  { 10, "ctrl_student_hil/Noise generator/Switch", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_T, Switch)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 20,
    0 },

  { 11, "ctrl_student_hil/Noise generator/Switch", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_T, Switch)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 22,
    0 },

  { 12, "ctrl_student_hil/DP Observer /Integrator", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, Integrator)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    24, 0 },

  { 13, "ctrl_student_hil/DP Observer /Integrator", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_T, Integrator)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    26, 0 },

  { 14, "ctrl_student_hil/DP Observer /Integrator", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_T, Integrator)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    28, 0 },

  { 15, "ctrl_student_hil/DP Observer /L1_diag", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, L1_diag)+0*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 30,
    0 },

  { 16, "ctrl_student_hil/DP Observer /L1_diag", 0, "(2,1)", offsetof
    (B_ctrl_student_HIL_T, L1_diag)+1*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 32,
    0 },

  { 17, "ctrl_student_hil/DP Observer /L1_diag", 0, "(3,1)", offsetof
    (B_ctrl_student_HIL_T, L1_diag)+2*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 34,
    0 },

  { 18, "ctrl_student_hil/DP Observer /L2_diag", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, L2_diag)+0*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 36,
    0 },

  { 19, "ctrl_student_hil/DP Observer /L2_diag", 0, "(2,1)", offsetof
    (B_ctrl_student_HIL_T, L2_diag)+1*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 38,
    0 },

  { 20, "ctrl_student_hil/DP Observer /L2_diag", 0, "(3,1)", offsetof
    (B_ctrl_student_HIL_T, L2_diag)+2*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 40,
    0 },

  { 21, "ctrl_student_hil/DP Observer /L3_diag", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, L3_diag)+0*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 42,
    0 },

  { 22, "ctrl_student_hil/DP Observer /L3_diag", 0, "(2,1)", offsetof
    (B_ctrl_student_HIL_T, L3_diag)+1*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 44,
    0 },

  { 23, "ctrl_student_hil/DP Observer /L3_diag", 0, "(3,1)", offsetof
    (B_ctrl_student_HIL_T, L3_diag)+2*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 46,
    0 },

  { 24, "ctrl_student_hil/DP Observer /Integrator1", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, Integrator1)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    48, 0 },

  { 25, "ctrl_student_hil/DP Observer /Integrator1", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_T, Integrator1)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    50, 0 },

  { 26, "ctrl_student_hil/DP Observer /Integrator1", 0, "(1,3)", offsetof
...
static NI_ExternalIO NI_ExtList[] DataSection(".NIVS.extlist") =
{
  ...
  { 3, "DP Observer /L1_diag", 0, EXT_IN, 3, 3, 1 },

  { 4, "DP Observer /L2_diag ", 0, EXT_IN, 3, 3, 1 },

  { 5, "DP Observer /L3_diag", 0, EXT_IN, 3, 3, 1 },

  { 6, "joystick/L2_continuous", 1, EXT_IN, 1, 1, 1 },

  { 7, "joystick/PosXRight", 0, EXT_IN, 1, 1, 1 },

  { 8, "joystick/PosYRight", 1, EXT_IN, 1, 1, 1 },

  { 9, "joystick/R2_continuous", 1, EXT_IN, 1, 1, 1 },

  { 10, "joystick/PosXLeft", 1, EXT_IN, 1, 1, 1 },

  { 11, "joystick/PosYLeft", 1, EXT_IN, 1, 1, 1 },

  { 12, "joystick/L1", 1, EXT_IN, 1, 1, 1 },

  { 13, "joystick/R1", 1, EXT_IN, 1, 1, 1 },

  { 14, "joystick/ArrowDown", 1, EXT_IN, 1, 1, 1 },

  { 15, "joystick/ArrowUp", 1, EXT_IN, 1, 1, 1 },
...
static char* NI_CompiledModelDateTime = "Fri Mar 03 10:29:36 2017";
