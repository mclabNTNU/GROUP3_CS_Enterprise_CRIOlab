...
extern void ctrl_student_HIL_MATLABFunction(real_T rtu_nu, real_T rtu_nu_p,
  real_T rtu_nu_o, const real_T rtu_alpha_dot[3], const real_T rtu_z_1[3], const
  real_T rtu_alpha_1[3], B_MATLABFunction_ctrl_student_T *localB);
extern void ctrl_student_HI_MATLABFunction1(B_MATLABFunction1_ctrl_studen_T
  *localB);
...
extern void ctrl_student_HI_MATLABFunction3(const real_T rtu_K_p[9], const
  real_T rtu_eta[3], const real_T rtu_eta_d[3], const real_T rtu_eta_d_s[3],
  real_T rtu_U_s, B_MATLABFunction3_ctrl_studen_T *localB);
