...
<inport> id="-1"  name = "noise pos" width = "1" datatype = "0"</inport>
<inport> id="-1"  name = "noise head" width = "1" datatype = "0"</inport>
...
<inport> id="-1"  name = "DP Observer /L1_diag" width = "3" datatype = "20"</inport>
<inport> id="-1"  name = "DP Observer /L2_diag " width = "3" datatype = "20"</inport>
<inport> id="-1"  name = "DP Observer /L3_diag" width = "3" datatype = "20"</inport>
...
<outport> id = "-1" name = "x_m" width = "1" datatype = "19"</outport>
<outport> id = "-1" name = "psi_m" width = "1" datatype = "19"</outport>
<outport> id = "-1" name = "y_m" width = "1" datatype = "19"</outport>
<outport> id = "-1" name = "DP Observer /x_hat" width = "1" datatype = "19"</outport>
<outport> id = "-1" name = "DP Observer /psi_hat" width = "1" datatype = "19"</outport>
<outport> id = "-1" name = "DP Observer /y_hat" width = "1" datatype = "19"</outport>
<outport> id = "-1" name = "DP Observer /r_dot" width = "1" datatype = "19"</outport>
<outport> id = "-1" name = "DP Observer /u_dot" width = "1" datatype = "19"</outport>
<outport> id = "-1" name = "DP Observer /v_dot" width = "1" datatype = "19"</outport>
