 ...
 * C source code generated on : Thu Feb 16 19:16:11 2017
 *
...
void ctrl_student_HIL_output(void)
{
  ...
  /* Clock: '<S2>/Clock' */
  rtb_Integrator = ctrl_student_HIL_M->Timing.t[0];

  /* Step: '<S2>/Step' */
  if (ctrl_student_HIL_M->Timing.t[0] < ctrl_student_HIL_P.Ramp_start) {
    u_idx_1 = ctrl_student_HIL_P.Step_Y0;
  } else {
    u_idx_1 = ctrl_student_HIL_P.Ramp_slope;
  }
   ...
   *  Sum: '<S2>/Sum'
   */
  rtb_Product = (rtb_Integrator - ctrl_student_HIL_P.Ramp_start) * u_idx_1;
  if (rtmIsMajorTimeStep(ctrl_student_HIL_M)) {
    /* MATLAB Function: '<S3>/MATLAB Function1' incorporates:
     *  Constant: '<Root>/Constant'
     */
    /* MATLAB Function 'SurgeObserver /MATLAB Function1': '<S15>:1' */
    /* '<S15>:1:2' */
    /* '<S15>:1:4' */
    u_idx_2 = ctrl_student_HIL_P.Constant_Value * 57.295779513082323;
    if ((-45.0 <= u_idx_2) && (u_idx_2 <= 135.0)) {
      /* '<S15>:1:6' */
      /* '<S15>:1:7' */
      ctrl_student_HIL_B.k_psi = 1.5;
    } else {
      /* '<S15>:1:9' */
      ctrl_student_HIL_B.k_psi = -1.5;
    }
   ...
   *  Sum: '<S3>/Sum'
   */
  ctrl_student_HIL_B.u_hat = ((rtb_Product + ctrl_student_HIL_P.Ramp_X0) +
    ctrl_student_HIL_P.Constant1_Value) * ctrl_student_HIL_B.k_psi +
    rtb_Integrator;
  if (rtmIsMajorTimeStep(ctrl_student_HIL_M)) {
  }

  /* MATLAB Function 'SurgeObserver /MATLAB Function': '<S14>:1' */
  /* '<S14>:1:2' */
  /* '<S14>:1:6' */
  if (rtmIsMajorTimeStep(ctrl_student_HIL_M)) {
     ...
     */
    ctrl_student_HIL_B.Product2 = (sin(ctrl_student_HIL_P.Constant_Value) + cos
      (ctrl_student_HIL_P.Constant_Value)) * ctrl_student_HIL_B.k_psi;
  }
  ...
  ctrl_student_HIL_B.Sum3 = (ctrl_student_HIL_P.Constant_Value_f - ((0.3545 *
    ...
    ctrl_student_HIL_B.u_hat * -3.787)) * ctrl_student_HIL_P.Gain2_Gain -
    ctrl_student_HIL_B.Product2 * ctrl_student_HIL_B.u_hat;
  if (rtmIsMajorTimeStep(ctrl_student_HIL_M)) {
     ...
     *  Memory: '<S4>/Memory1'
     */
    /* MATLAB Function 'joystick/MATLAB Function': '<S16>:1' */
    /* '<S16>:1:7' */
    /* '<S16>:1:9' */
    ...
    /* '<S16>:1:11' */
    if ((ctrl_student_HIL_B.ArrowUp > 0.5) &&
        (ctrl_student_HIL_DW.Memory1_PreviousInput != ctrl_student_HIL_B.ArrowUp))
    {
      /* '<S16>:1:12' */
      /* '<S16>:1:13' */
      mem_out = -ctrl_student_HIL_DW.Memory_PreviousInput;
    } else {
      /* '<S16>:1:15' */
      mem_out = ctrl_student_HIL_DW.Memory_PreviousInput;
    }
    ...
    switch ((int32_T)mem_out) {
     ...
     default:
      ...
      rtb_Product = u_idx_2 / 1.165 * u_idx_1;
...
void ctrl_student_HIL_update(void)
{
  if (rtmIsMajorTimeStep(ctrl_student_HIL_M)) {
    ...
    ctrl_student_HIL_DW.Memory_PreviousInput = ctrl_student_HIL_B.mem_out;
...
RT_MODEL_ctrl_student_HIL_T *ctrl_student_HIL(void)
{
  ...
  ctrl_student_HIL_M->Sizes.numBlocks = (83);/* Number of blocks */
  ctrl_student_HIL_M->Sizes.numBlockIO = (24);/* Number of block outputs */
  ctrl_student_HIL_M->Sizes.numBlockPrms = (184);/* Sum of parameter "widths" */
...
{
  { 0, "ctrl_student_hil/Ramp/Constant1/Value", offsetof(P_ctrl_student_HIL_T,
    Ramp_X0), 27, 1, 2, 0, 0 },

  { 1, "ctrl_student_hil/Ramp/Step/After", offsetof(P_ctrl_student_HIL_T,
    Ramp_slope), 27, 1, 2, 2, 0 },

  { 2, "ctrl_student_hil/Ramp/Constant/Value", offsetof(P_ctrl_student_HIL_T,
    Ramp_start), 27, 1, 2, 4, 0 },

  { 3, "ctrl_student_hil/Ramp/Step/Time", offsetof(P_ctrl_student_HIL_T,
    Ramp_start), 27, 1, 2, 6, 0 },

  { 4, "ctrl_student_hil/Noise generator/Step size/Value", offsetof
    (P_ctrl_student_HIL_T, Stepsize_Value), 27, 1, 2, 8, 0 },

  { 5, "ctrl_student_hil/Noise generator/Downsamplesignal/counter/X0", offsetof
    (P_ctrl_student_HIL_T, counter_X0), 27, 1, 2, 10, 0 },

  { 6, "ctrl_student_hil/Noise generator/Sample & hold/Hold/X0", offsetof
    (P_ctrl_student_HIL_T, Hold_X0), 27, 1, 2, 12, 0 },

  { 7,
    "ctrl_student_hil/Noise generator/noise generator/Band-limited white noise x/White Noise/Mean",
    offsetof(P_ctrl_student_HIL_T, WhiteNoise_Mean), 27, 1, 2, 14, 0 },

  { 8,
    "ctrl_student_hil/Noise generator/noise generator/Band-limited white noise x/White Noise/StdDev",
    offsetof(P_ctrl_student_HIL_T, WhiteNoise_StdDev), 27, 1, 2, 16, 0 },

  { 9,
    "ctrl_student_hil/Noise generator/noise generator/Band-limited white noise x/White Noise/Seed",
    offsetof(P_ctrl_student_HIL_T, WhiteNoise_Seed), 27, 1, 2, 18, 0 },

  { 10,
    "ctrl_student_hil/Noise generator/noise generator/Band-limited white noise y/White Noise/Mean",
    offsetof(P_ctrl_student_HIL_T, WhiteNoise_Mean_h), 27, 1, 2, 20, 0 },

  { 11,
    "ctrl_student_hil/Noise generator/noise generator/Band-limited white noise y/White Noise/StdDev",
    offsetof(P_ctrl_student_HIL_T, WhiteNoise_StdDev_d), 27, 1, 2, 22, 0 },

  { 12,
    "ctrl_student_hil/Noise generator/noise generator/Band-limited white noise y/White Noise/Seed",
    offsetof(P_ctrl_student_HIL_T, WhiteNoise_Seed_b), 27, 1, 2, 24, 0 },

  { 13,
    "ctrl_student_hil/Noise generator/noise generator/Band-limited white noise psi/White Noise/Mean",
    offsetof(P_ctrl_student_HIL_T, WhiteNoise_Mean_f), 27, 1, 2, 26, 0 },

  { 14,
    "ctrl_student_hil/Noise generator/noise generator/Band-limited white noise psi/White Noise/StdDev",
    offsetof(P_ctrl_student_HIL_T, WhiteNoise_StdDev_g), 27, 1, 2, 28, 0 },

  { 15,
    "ctrl_student_hil/Noise generator/noise generator/Band-limited white noise psi/White Noise/Seed",
    offsetof(P_ctrl_student_HIL_T, WhiteNoise_Seed_l), 27, 1, 2, 30, 0 },

  { 16, "ctrl_student_hil/Ramp/Step/Before", offsetof(P_ctrl_student_HIL_T,
    Step_Y0), 27, 1, 2, 32, 0 },

  { 17, "ctrl_student_hil/Constant1/Value", offsetof(P_ctrl_student_HIL_T,
    Constant1_Value), 27, 1, 2, 34, 0 },

  { 18, "ctrl_student_hil/Constant/Value", offsetof(P_ctrl_student_HIL_T,
    Constant_Value), 27, 1, 2, 36, 0 },

  { 19, "ctrl_student_hil/SurgeObserver /Integrator/InitialCondition", offsetof
    (P_ctrl_student_HIL_T, Integrator_IC), 27, 1, 2, 38, 0 },

  { 20, "ctrl_student_hil/SurgeObserver /Constant/Value", offsetof
    (P_ctrl_student_HIL_T, Constant_Value_f), 27, 1, 2, 40, 0 },

  { 21, "ctrl_student_hil/SurgeObserver /Gain2/Gain", offsetof
    (P_ctrl_student_HIL_T, Gain2_Gain), 27, 1, 2, 42, 0 },

  { 22, "ctrl_student_hil/joystick/Gain/Gain", offsetof(P_ctrl_student_HIL_T,
    Gain_Gain), 27, 1, 2, 44, 0 },

  { 23, "ctrl_student_hil/joystick/Memory/X0", offsetof(P_ctrl_student_HIL_T,
    Memory_X0), 27, 1, 2, 46, 0 },

  { 24, "ctrl_student_hil/joystick/Memory1/X0", offsetof(P_ctrl_student_HIL_T,
    Memory1_X0), 27, 1, 2, 48, 0 },

  { 25,
    "ctrl_student_hil/tau to CSE mocell (only use for HIL testing)/Constant2/Value",
    offsetof(P_ctrl_student_HIL_T, Constant2_Value), 27, 1, 2, 50, 0 },

  { 26,
    "ctrl_student_hil/tau to CSE mocell (only use for HIL testing)/Constant/Value",
    offsetof(P_ctrl_student_HIL_T, Constant_Value_i), 27, 1, 2, 52, 0 },

  { 27,
    "ctrl_student_hil/tau to CSE mocell (only use for HIL testing)/Constant1/Value",
    offsetof(P_ctrl_student_HIL_T, Constant1_Value_h), 27, 1, 2, 54, 0 },
};
...
static NI_Signal NI_SigList[] DataSection(".NIVS.siglist") =
{
  ...
  { 6, "ctrl_student_hil/SurgeObserver /Sum4", 0, "u_hat", offsetof
    (B_ctrl_student_HIL_T, u_hat)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 12, 0
  },

  { 7, "ctrl_student_hil/SurgeObserver /Product2", 0, "", offsetof
    (B_ctrl_student_HIL_T, Product2)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 14,
    0 },

  { 8, "ctrl_student_hil/SurgeObserver /Sum3", 0, "", offsetof
    (B_ctrl_student_HIL_T, Sum3)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 16, 0 },
  ...
  { 13, "ctrl_student_hil/joystick/Gain", 0, "", offsetof(B_ctrl_student_HIL_T,
    Gain)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 26, 0 },

  { 14, "ctrl_student_hil/joystick/ArrowUp", 0, "", offsetof
    (B_ctrl_student_HIL_T, ArrowUp)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 28,
    0 },

  { 15, "ctrl_student_hil/joystick/MATLAB Function", 0, "u_vsp", offsetof
    (B_ctrl_student_HIL_T, u_vsp)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 30, 0
  },

  { 16, "ctrl_student_hil/joystick/MATLAB Function", 1, "u_bt", offsetof
    (B_ctrl_student_HIL_T, u_bt)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 32, 0 },

  { 17, "ctrl_student_hil/joystick/MATLAB Function", 2, "alpha", offsetof
    (B_ctrl_student_HIL_T, alpha)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 34, 0
  },

  { 18, "ctrl_student_hil/joystick/MATLAB Function", 3, "omega", offsetof
    (B_ctrl_student_HIL_T, omega)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 36, 0
  },

  { 19, "ctrl_student_hil/joystick/MATLAB Function", 4, "mem_out", offsetof
    (B_ctrl_student_HIL_T, mem_out)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 38,
    0 },

  { 20, "ctrl_student_hil/joystick/MATLAB Function", 5, "hold_out", offsetof
    (B_ctrl_student_HIL_T, hold_out)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 40,
    0 },

  { 21, "ctrl_student_hil/SurgeObserver /MATLAB Function1", 0, "k_psi", offsetof
    (B_ctrl_student_HIL_T, k_psi)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 42, 0
  },
  ...
  { 24, "ctrl_student_hil/Noise generator/Sample & hold/MATLAB Function1", 0,
    "output(1,3)", offsetof(B_ctrl_student_HIL_T, output)+2*sizeof(real_T),
    BLOCKIO_SIG, 17, 1, 2, 48, 0 },

  { 25, "ctrl_student_hil/Noise generator/Downsamplesignal/MATLAB Function", 0,
...
static int NI_SigListSize DataSection(".NIVS.siglistsize") = 26;
...
static NI_ExternalIO NI_ExtList[] DataSection(".NIVS.extlist") =
{
  ...
  { 1, "joystick/alpha_VSP2", 1, EXT_OUT, 1, 1, 1 },

  { 2, "joystick/alpha_VSP1", 1, EXT_OUT, 1, 1, 1 },

  { 3, "joystick/u_VSP2", 1, EXT_OUT, 1, 1, 1 },

  { 4, "joystick/omega_VSP1", 1, EXT_OUT, 1, 1, 1 },

  { 5, "joystick/omega_VSP2", 1, EXT_OUT, 1, 1, 1 },

  { 6, "joystick/u_BT", 1, EXT_OUT, 1, 1, 1 },

  { 7, "joystick/Combine", 1, EXT_OUT, 1, 1, 1 },

  { 8, "tau to CSE mocell (only use for HIL testing)/X_d", 1, EXT_OUT, 1, 1, 1 },

  { 9, "tau to CSE mocell (only use for HIL testing)/N_d", 1, EXT_OUT, 1, 1, 1 },

  { 10, "tau to CSE mocell (only use for HIL testing)/Y_d", 1, EXT_OUT, 1, 1, 1
  },
...
static char* NI_CompiledModelName DataSection(".NIVS.compiledmodelname") =
  "ctrl_student_hil";
static char* NI_CompiledModelVersion = "1.160";
static char* NI_CompiledModelDateTime = "Thu Feb 16 19:16:10 2017";
  ...
  * discStates, long* numClockTicks, char* clockTicksNames, long* clockTicks)
{
  ...
  if (discStates && discStatesNames) {
    ...
    for (count = 0; count < 17; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_DW.Combine_DWORK2, count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100),
