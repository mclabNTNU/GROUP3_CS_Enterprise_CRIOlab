 ...
 * C source code generated on : Wed Mar 22 13:05:33 2017
 *
...
void ctrl_student_HIL_output(void)
{
  ...
  if (rtmIsMajorTimeStep(ctrl_student_HIL_M)) {
     ...
     *  Sqrt: '<S11>/Sqrt'
     */
    ctrl_student_HIL_B.Product_e = sqrt(ctrl_student_HIL_P.Constant2_Value /
  ...
  /* Sum: '<Root>/Sum' */
  rtb_Sum_d = ctrl_student_HIL_B.L2_continuous -
  ...
  if (ctrl_student_HIL_B.count == 0.0) {
    ...
    ctrl_student_HIL_B.output[2] = ctrl_student_HIL_B.Product_e + rtb_Sum_d;
  } else {
    /* '<S10>:1:7' */
   ...
   */
  if (ctrl_student_HIL_P.Constant3_Value != 0.0) {
    ...
    ctrl_student_HIL_B.Switch[2] = rtb_Sum_d;
  }
  ...
  /* '<S5>:1:17' */
  rtb_Sum_d = ctrl_student_HIL_B.Switch[0] - ctrl_student_HIL_B.Memory4[0];
  ...
  /* '<S5>:1:18' */
  ctrl_student_HIL_B.x_bar = rtb_Sum_d;
  ...
  for (i = 0; i < 3; i++) {
    ctrl_student_HIL_B.b_hat_dot[i] = ((L3[i + 3] * eta_bar_idx_1 + L3[i] *
      rtb_Sum_d) + L3[i + 6] * eta_bar_idx_2) + ctrl_student_HIL_B.b;
  }
...
RT_MODEL_ctrl_student_HIL_T *ctrl_student_HIL(void)
{
  ...
  ctrl_student_HIL_M->Sizes.numBlockPrms = (272);/* Sum of parameter "widths" */
...
{
  { 0, "ctrl_student_hil/Constant4/Value", offsetof(P_ctrl_student_HIL_T,
    Constant4_Value), 29, 1, 2, 0, 0 },

  { 1, "ctrl_student_hil/Noise generator/Step size/Value", offsetof
    (P_ctrl_student_HIL_T, Stepsize_Value), 29, 1, 2, 2, 0 },

  { 2, "ctrl_student_hil/Noise generator/Downsamplesignal/counter/X0", offsetof
    (P_ctrl_student_HIL_T, counter_X0), 29, 1, 2, 4, 0 },

  { 3, "ctrl_student_hil/Constant1/Value", offsetof(P_ctrl_student_HIL_T,
    Constant1_Value), 29, 1, 2, 6, 0 },
  ...
  { 15, "ctrl_student_hil/Constant3/Value", offsetof(P_ctrl_student_HIL_T,
    Constant3_Value), 29, 1, 2, 30, 0 },

  { 16, "ctrl_student_hil/DP Observer /Integrator/InitialCondition", offsetof
    (P_ctrl_student_HIL_T, Integrator_IC), 29, 1, 2, 32, 0 },

  { 17, "ctrl_student_hil/DP Observer /Integrator1/InitialCondition", offsetof
    (P_ctrl_student_HIL_T, Integrator1_IC), 29, 1, 2, 34, 0 },

  { 18, "ctrl_student_hil/DP Observer /Memory4/X0", offsetof
    (P_ctrl_student_HIL_T, Memory4_X0), 18, 3, 2, 36, 0 },

  { 19, "ctrl_student_hil/DP Observer /Memory3/X0", offsetof
    (P_ctrl_student_HIL_T, Memory3_X0), 18, 3, 2, 38, 0 },

  { 20, "ctrl_student_hil/DP Observer /Memory2/X0", offsetof
    (P_ctrl_student_HIL_T, Memory2_X0), 18, 3, 2, 40, 0 },

  { 21, "ctrl_student_hil/DP Observer /Integrator2/InitialCondition", offsetof
    (P_ctrl_student_HIL_T, Integrator2_IC), 29, 1, 2, 42, 0 },

  { 22,
    "ctrl_student_hil/tau to CSE mocell (only use for HIL testing)/Constant2/Value",
    offsetof(P_ctrl_student_HIL_T, Constant2_Value_e), 29, 1, 2, 44, 0 },

  { 23,
    "ctrl_student_hil/tau to CSE mocell (only use for HIL testing)/Constant/Value",
    offsetof(P_ctrl_student_HIL_T, Constant_Value), 29, 1, 2, 46, 0 },

  { 24,
    "ctrl_student_hil/tau to CSE mocell (only use for HIL testing)/Constant1/Value",
    offsetof(P_ctrl_student_HIL_T, Constant1_Value_h), 29, 1, 2, 48, 0 },
};
...
static NI_Signal NI_SigList[] DataSection(".NIVS.siglist") =
{
  ...
  { 5, "ctrl_student_hil/joystick/PosXRight", 0, "", offsetof
    (B_ctrl_student_HIL_T, PosXRight)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 10,
    0 },

  { 6, "ctrl_student_hil/joystick/PosYRight", 0, "", offsetof
    (B_ctrl_student_HIL_T, PosYRight)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 12,
    0 },

  { 7, "ctrl_student_hil/joystick/R2_continuous", 0, "", offsetof
    (B_ctrl_student_HIL_T, R2_continuous)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    14, 0 },

  { 8, "ctrl_student_hil/joystick/PosXLeft", 0, "", offsetof
    (B_ctrl_student_HIL_T, PosXLeft)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 16,
    0 },

  { 9, "ctrl_student_hil/joystick/PosYLeft", 0, "", offsetof
    (B_ctrl_student_HIL_T, PosYLeft)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 18,
    0 },

  { 10, "ctrl_student_hil/joystick/L1", 0, "", offsetof(B_ctrl_student_HIL_T, L1)
    +0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 20, 0 },

  { 11, "ctrl_student_hil/joystick/R1", 0, "", offsetof(B_ctrl_student_HIL_T, R1)
  ...
  { 13, "ctrl_student_hil/joystick/ArrowUp", 0, "", offsetof
    (B_ctrl_student_HIL_T, ArrowUp)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 26,
    0 },

  { 14, "ctrl_student_hil/joystick/ArrowLeft", 0, "", offsetof
    (B_ctrl_student_HIL_T, ArrowLeft)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 28,
    0 },

  { 15, "ctrl_student_hil/joystick/ArrowRight", 0, "", offsetof
    (B_ctrl_student_HIL_T, ArrowRight)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    30, 0 },

  { 16, "ctrl_student_hil/x_in", 0, "", offsetof(B_ctrl_student_HIL_T, x_in)+0*
  ...
  { 20, "ctrl_student_hil/Noise generator/Switch", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, Switch)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 40,
    0 },

  { 21, "ctrl_student_hil/Noise generator/Switch", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_T, Switch)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 42,
    0 },

  { 22, "ctrl_student_hil/Noise generator/Switch", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_T, Switch)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 44,
    0 },

  { 23, "ctrl_student_hil/DP Observer /Integrator", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, Integrator)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    46, 0 },

  { 24, "ctrl_student_hil/DP Observer /Integrator", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_T, Integrator)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    48, 0 },

  { 25, "ctrl_student_hil/DP Observer /Integrator", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_T, Integrator)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    50, 0 },

  { 26, "ctrl_student_hil/DP Observer /L1_diag", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, L1_diag)+0*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 52,
    0 },

  { 27, "ctrl_student_hil/DP Observer /L1_diag", 0, "(2,1)", offsetof
    (B_ctrl_student_HIL_T, L1_diag)+1*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 54,
    0 },

  { 28, "ctrl_student_hil/DP Observer /L1_diag", 0, "(3,1)", offsetof
    (B_ctrl_student_HIL_T, L1_diag)+2*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 56,
    0 },

  { 29, "ctrl_student_hil/DP Observer /L2_diag", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, L2_diag)+0*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 58,
    0 },

  { 30, "ctrl_student_hil/DP Observer /L2_diag", 0, "(2,1)", offsetof
    (B_ctrl_student_HIL_T, L2_diag)+1*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 60,
    0 },

  { 31, "ctrl_student_hil/DP Observer /L2_diag", 0, "(3,1)", offsetof
    (B_ctrl_student_HIL_T, L2_diag)+2*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 62,
    0 },

  { 32, "ctrl_student_hil/DP Observer /L3_diag", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, L3_diag)+0*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 64,
    0 },

  { 33, "ctrl_student_hil/DP Observer /L3_diag", 0, "(2,1)", offsetof
    (B_ctrl_student_HIL_T, L3_diag)+1*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 66,
    0 },

  { 34, "ctrl_student_hil/DP Observer /L3_diag", 0, "(3,1)", offsetof
    (B_ctrl_student_HIL_T, L3_diag)+2*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 68,
    0 },

  { 35, "ctrl_student_hil/DP Observer /Integrator1", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, Integrator1)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    70, 0 },

  { 36, "ctrl_student_hil/DP Observer /Integrator1", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_T, Integrator1)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    72, 0 },

  { 37, "ctrl_student_hil/DP Observer /Integrator1", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_T, Integrator1)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    74, 0 },

  { 38, "ctrl_student_hil/DP Observer /b", 0, "", offsetof(B_ctrl_student_HIL_T,
    b)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 76, 0 },

  { 39, "ctrl_student_hil/DP Observer /Memory4", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, Memory4)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 78,
    0 },

  { 40, "ctrl_student_hil/DP Observer /Memory4", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_T, Memory4)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 80,
    0 },

  { 41, "ctrl_student_hil/DP Observer /Memory4", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_T, Memory4)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 82,
    0 },

  { 42, "ctrl_student_hil/DP Observer /Memory3", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, Memory3)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 84,
    0 },

  { 43, "ctrl_student_hil/DP Observer /Memory3", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_T, Memory3)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 86,
    0 },

  { 44, "ctrl_student_hil/DP Observer /Memory3", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_T, Memory3)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 88,
    0 },

  { 45, "ctrl_student_hil/DP Observer /Memory2", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, Memory2)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 90,
    0 },

  { 46, "ctrl_student_hil/DP Observer /Memory2", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_T, Memory2)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 92,
    0 },

  { 47, "ctrl_student_hil/DP Observer /Memory2", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_T, Memory2)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 94,
    0 },

  { 48, "ctrl_student_hil/DP Observer /Integrator2", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, Integrator2)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    96, 0 },

  { 49, "ctrl_student_hil/DP Observer /Integrator2", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_T, Integrator2)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    98, 0 },

  { 50, "ctrl_student_hil/DP Observer /Integrator2", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_T, Integrator2)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    100, 0 },

  { 51, "ctrl_student_hil/r_in", 0, "", offsetof(B_ctrl_student_HIL_T, r_in)+0*
    sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 102, 0 },

  { 52, "ctrl_student_hil/u_in", 0, "", offsetof(B_ctrl_student_HIL_T, u_in)+0*
    sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 104, 0 },

  { 53, "ctrl_student_hil/v_in", 0, "", offsetof(B_ctrl_student_HIL_T, v_in)+0*
  ...
  { 56, "ctrl_student_hil/Noise generator/Sample & hold/MATLAB Function1", 0,
    "output(1,3)", offsetof(B_ctrl_student_HIL_T, output)+2*sizeof(real_T),
    BLOCKIO_SIG, 17, 1, 2, 112, 0 },

  { 57, "ctrl_student_hil/Noise generator/Downsamplesignal/MATLAB Function", 0,
    "count", offsetof(B_ctrl_student_HIL_T, count)+0*sizeof(real_T), BLOCKIO_SIG,
    0, 1, 2, 114, 0 },

  { 58, "ctrl_student_hil/DP Observer /Observer", 0, "eta_hat_dot(1,1)",
    offsetof(B_ctrl_student_HIL_T, eta_hat_dot)+0*sizeof(real_T), BLOCKIO_SIG,
    17, 1, 2, 116, 0 },

  { 59, "ctrl_student_hil/DP Observer /Observer", 0, "eta_hat_dot(1,2)",
    offsetof(B_ctrl_student_HIL_T, eta_hat_dot)+1*sizeof(real_T), BLOCKIO_SIG,
    17, 1, 2, 118, 0 },

  { 60, "ctrl_student_hil/DP Observer /Observer", 0, "eta_hat_dot(1,3)",
    offsetof(B_ctrl_student_HIL_T, eta_hat_dot)+2*sizeof(real_T), BLOCKIO_SIG,
    17, 1, 2, 120, 0 },

  { 61, "ctrl_student_hil/DP Observer /Observer", 1, "nu_hat_dot(1,1)", offsetof
    (B_ctrl_student_HIL_T, nu_hat_dot)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    122, 0 },

  { 62, "ctrl_student_hil/DP Observer /Observer", 1, "nu_hat_dot(1,2)", offsetof
    (B_ctrl_student_HIL_T, nu_hat_dot)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    124, 0 },

  { 63, "ctrl_student_hil/DP Observer /Observer", 1, "nu_hat_dot(1,3)", offsetof
    (B_ctrl_student_HIL_T, nu_hat_dot)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    126, 0 },

  { 64, "ctrl_student_hil/DP Observer /Observer", 2, "b_hat_dot(1,1)", offsetof
    (B_ctrl_student_HIL_T, b_hat_dot)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    128, 0 },

  { 65, "ctrl_student_hil/DP Observer /Observer", 2, "b_hat_dot(1,2)", offsetof
    (B_ctrl_student_HIL_T, b_hat_dot)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    130, 0 },

  { 66, "ctrl_student_hil/DP Observer /Observer", 2, "b_hat_dot(1,3)", offsetof
    (B_ctrl_student_HIL_T, b_hat_dot)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    132, 0 },

  { 67, "ctrl_student_hil/DP Observer /Observer", 3, "x_bar", offsetof
    (B_ctrl_student_HIL_T, x_bar)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 134, 0
  },

  { 68, "ctrl_student_hil/DP Observer /Observer", 4, "y_bar", offsetof
    (B_ctrl_student_HIL_T, y_bar)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 136, 0
  },

  { 69, "ctrl_student_hil/DP Observer /Observer", 5, "psi_bar", offsetof
    (B_ctrl_student_HIL_T, psi_bar)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 138,
    0 },

  { -1, "", -1, "", 0, 0, 0 }
};

static int NI_SigListSize DataSection(".NIVS.siglistsize") = 70;
...
static NI_ExternalIO NI_ExtList[] DataSection(".NIVS.extlist") =
{
  ...
  { 1, "joystick/L2_continuous", 0, EXT_IN, 1, 1, 1 },

  { 2, "joystick/PosXRight", 0, EXT_IN, 1, 1, 1 },

  { 3, "joystick/PosYRight", 1, EXT_IN, 1, 1, 1 },

  { 4, "joystick/R2_continuous", 0, EXT_IN, 1, 1, 1 },

  { 5, "joystick/PosXLeft", 1, EXT_IN, 1, 1, 1 },

  { 6, "joystick/PosYLeft", 1, EXT_IN, 1, 1, 1 },

  { 7, "joystick/L1", 1, EXT_IN, 1, 1, 1 },

  { 8, "joystick/R1", 1, EXT_IN, 1, 1, 1 },

  { 9, "joystick/ArrowDown", 1, EXT_IN, 1, 1, 1 },

  { 10, "joystick/ArrowUp", 1, EXT_IN, 1, 1, 1 },

  { 11, "joystick/ArrowLeft", 1, EXT_IN, 1, 1, 1 },

  { 12, "joystick/ArrowRight", 1, EXT_IN, 1, 1, 1 },

  { 13, "x_in", 0, EXT_IN, 1, 1, 1 },

  { 14, "DP Observer /L1_diag", 0, EXT_IN, 3, 3, 1 },

  { 15, "DP Observer /L2_diag ", 0, EXT_IN, 3, 3, 1 },

  { 16, "DP Observer /L3_diag", 0, EXT_IN, 3, 3, 1 },

  { 17, "DP Observer /b", 0, EXT_IN, 1, 1, 1 },

  { 18, "r_in", 1, EXT_IN, 1, 1, 1 },

  { 19, "u_in", 1, EXT_IN, 1, 1, 1 },

  { 20, "v_in", 1, EXT_IN, 1, 1, 1 },

  { 0, "x_m", 0, EXT_OUT, 1, 1, 1 },

  { 1, "psi_m", 0, EXT_OUT, 1, 1, 1 },

  { 2, "DP Observer /x_hat", 0, EXT_OUT, 1, 1, 1 },

  { 3, "DP Observer /psi_hat", 0, EXT_OUT, 1, 1, 1 },

  { 4, "DP Observer /y_hat", 0, EXT_OUT, 1, 1, 1 },
  ...
  { 8, "DP Observer /y_bar", 0, EXT_OUT, 1, 1, 1 },

  { 9, "DP Observer /psi_bar", 0, EXT_OUT, 1, 1, 1 },

  { 10, "DP Observer /x_bar", 0, EXT_OUT, 1, 1, 1 },
...
static char* NI_CompiledModelDateTime = "Wed Mar 22 13:05:32 2017";
