...
void ctrl_student_HIL_output(void)
{
  ...
  real_T z1[3];
  real_T t;
  static const real_T a_0[9] = { 16.79, 0.0, 0.0, 0.0, 24.79,
    0.55462499999999992, 0.0, 0.55462499999999992, 2.76 };

  static const int8_T b_a_0[9] = { -1, 0, 0, 0, -1, 0, 0, 0, -1 };
  ...
  real_T rtb_eta_ds_idx_0;
  real_T rtb_eta_ds_idx_1;
   ...
   *  Sqrt: '<S15>/Sqrt'
   */
  rtb_Product = sqrt(ctrl_student_HIL_B.noisepos /
   ...
   *  Sqrt: '<S16>/Sqrt'
   */
  rtb_Product_f = sqrt(ctrl_student_HIL_B.noisepos /
                       ctrl_student_HIL_P.Stepsize_Value) *
   ...
   *  Sqrt: '<S14>/Sqrt'
   */
  rtb_Product_c = sqrt(ctrl_student_HIL_B.noisehead /
                       ctrl_student_HIL_P.Stepsize_Value) *
    ctrl_student_HIL_B.WhiteNoise_m;
  if (rtmIsMajorTimeStep(ctrl_student_HIL_M)) {
    /* Constant: '<Root>/Constant1' */
    ctrl_student_HIL_B.Constant1 = ctrl_student_HIL_P.Constant1_Value;
  }
  ...
  if (rtmIsMajorTimeStep(ctrl_student_HIL_M)) {
    ...
    if (zcEvent || ctrl_student_HIL_DW.Integrator1_IWORK.IcNeedsLoading) {
      ctrl_student_HIL_X.Integrator1_CSTATE[0] = ctrl_student_HIL_B.Constant1;
      ctrl_student_HIL_X.Integrator1_CSTATE[1] = ctrl_student_HIL_B.Constant1;
      ctrl_student_HIL_X.Integrator1_CSTATE[2] = ctrl_student_HIL_B.Constant1;
    }
  }
  ...
  if (ctrl_student_HIL_B.count == 0.0) {
    /* '<S13>:1:4' */
    /* '<S13>:1:5' */
    ctrl_student_HIL_B.output[0] = rtb_Product + rtb_Integrator1[0];
    ctrl_student_HIL_B.output[1] = rtb_Product_f + rtb_Integrator1[1];
    ctrl_student_HIL_B.output[2] = rtb_Product_c + rtb_Integrator1[2];
  } else {
    /* '<S13>:1:7' */
  ...
  if (ctrl_student_HIL_B.enablenoise != 0.0) {
    ...
    ctrl_student_HIL_B.Switch[0] = rtb_Integrator1[0];
    ctrl_student_HIL_B.Switch[1] = rtb_Integrator1[1];
    ctrl_student_HIL_B.Switch[2] = rtb_Integrator1[2];
  }
  ...
  ctrl_student_HIL_B.Integrator1[0] = ctrl_student_HIL_X.Integrator1_CSTATE_l[0];
  ctrl_student_HIL_B.Integrator1[1] = ctrl_student_HIL_X.Integrator1_CSTATE_l[1];
  ctrl_student_HIL_B.Integrator1[2] = ctrl_student_HIL_X.Integrator1_CSTATE_l[2];
  if (rtmIsMajorTimeStep(ctrl_student_HIL_M)) {
    /* Memory: '<S1>/Memory4' */
  ...
  /* MATLAB Function 'DP Observer /Observer ': '<S8>:1' */
  /*  if(first == 1) */
  /*  eta_hat = zeros(3,1) ;  */
  /*  nu_hat = zeros(3,1);  */
  /*  b_hau = zeros(3,1) */
  ...
  /* '<S8>:1:19' */
  eta_bar_idx_0 = ctrl_student_HIL_B.Switch[0] - ctrl_student_HIL_B.Memory4[0];
  ...
  for (i = 0; i < 3; i++) {
    b_a_1[i] = b_a[i + 6] * ctrl_student_HIL_B.Memory3[2] + (b_a[i + 3] *
  ...
  for (i = 0; i < 3; i++) {
    for (i_0 = 0; i_0 < 3; i_0++) {
      L3[i + 3 * i_0] = 0.0;
      L3[i + 3 * i_0] += R[3 * i] * L2[3 * i_0];
      L3[i + 3 * i_0] += R[3 * i + 1] * L2[3 * i_0 + 1];
      L3[i + 3 * i_0] += R[3 * i + 2] * L2[3 * i_0 + 2];
    }
  }

  for (i = 0; i < 3; i++) {
    b_a_2[i] = ((L3[i + 3] * eta_bar_idx_1 + L3[i] * eta_bar_idx_0) + L3[i + 6] *
                eta_bar_idx_2) + (b_a_1[i] + R_0[i]);
  }

  for (i = 0; i < 3; i++) {
    ctrl_student_HIL_B.nu_hat_dot[i] = 0.0;
    ctrl_student_HIL_B.nu_hat_dot[i] += a[i] * b_a_2[0];
    ctrl_student_HIL_B.nu_hat_dot[i] += a[i + 3] * b_a_2[1];
    ctrl_student_HIL_B.nu_hat_dot[i] += a[i + 6] * b_a_2[2];
  }
  ...
  rtb_Product = ctrl_student_HIL_X.Integrator_CSTATE_f;
  ...
  if (rtmIsMajorTimeStep(ctrl_student_HIL_M)) {
    ...
    if (zcEvent) {
      ctrl_student_HIL_X.Integrator_CSTATE_b[0] =
        (ctrl_student_HIL_P.Integrator_IC_n[0]);
      ctrl_student_HIL_X.Integrator_CSTATE_b[1] =
        (ctrl_student_HIL_P.Integrator_IC_n[1]);
      ctrl_student_HIL_X.Integrator_CSTATE_b[2] =
        (ctrl_student_HIL_P.Integrator_IC_n[2]);
    }
  }

  rtb_Integrator_p[0] = ctrl_student_HIL_X.Integrator_CSTATE_b[0];
  rtb_Integrator_p[1] = ctrl_student_HIL_X.Integrator_CSTATE_b[1];
  rtb_Integrator_p[2] = ctrl_student_HIL_X.Integrator_CSTATE_b[2];
  ...
  /* '<S3>:1:7' */
  /* '<S3>:1:8' */
  rtb_Product_f = ctrl_student_HIL_P.Constant6_Value[0] -
    ctrl_student_HIL_B.Constant1;

  /* '<S3>:1:9' */
  rtb_Product_c = ctrl_student_HIL_P.Constant6_Value[1] -
    ctrl_student_HIL_B.Constant1;
  ...
  /* '<S3>:1:15' */
  /* '<S3>:1:17' */
  eta_bar_idx_0 = (ctrl_student_HIL_P.Constant6_Value[0] -
                   ctrl_student_HIL_B.Constant1) * rtb_Product +
    ctrl_student_HIL_B.Constant1;
  eta_bar_idx_1 = (ctrl_student_HIL_P.Constant6_Value[1] -
                   ctrl_student_HIL_B.Constant1) * rtb_Product +
    ctrl_student_HIL_B.Constant1;
  eta_bar_idx_2 = rt_atan2d_snf(rtb_Product_c, rtb_Product_f);

  /* '<S3>:1:18' */
  rtb_eta_ds_idx_0 = rtb_Product_f;
  rtb_eta_ds_idx_1 = rtb_Product_c;

  /* '<S3>:1:19' */
  /* '<S3>:1:20' */
  rtb_Product = ctrl_student_HIL_P.Constant6_Value[0] -
    ctrl_student_HIL_B.Constant1;
  rtb_Product_f = ctrl_student_HIL_P.Constant6_Value[1] -
    ctrl_student_HIL_B.Constant1;
  rtb_Us = ctrl_student_HIL_P.Constant5_Value / sqrt(rtb_Product * rtb_Product +
    rtb_Product_f * rtb_Product_f);
  ...
  /* '<S2>:1:43' */
  /* '<S2>:1:47' */
  R[0] = cos(rtb_Integrator1[2]);
  R[3] = -sin(rtb_Integrator1[2]);
  R[6] = 0.0;
  R[1] = sin(rtb_Integrator1[2]);
  R[4] = cos(rtb_Integrator1[2]);
  R[7] = 0.0;
  R[2] = 0.0;
  R[5] = 0.0;
  R[8] = 1.0;
  ...
  /* '<S2>:1:51' */
  rtb_Product_f = rtb_Integrator1[0] - eta_bar_idx_0;
  rtb_Product_c = rtb_Integrator1[1] - eta_bar_idx_1;
  t = rtb_Integrator1[2] - eta_bar_idx_2;
  for (i = 0; i < 3; i++) {
    z1[i] = R[3 * i + 2] * t + (R[3 * i + 1] * rtb_Product_c + R[3 * i] *
      rtb_Product_f);
  }

  /* '<S2>:1:54' */
  L1[0] = 0.0;
  L1[3] = -rtb_Integrator_p[2];
  L1[6] = 0.0;
  L1[1] = rtb_Integrator_p[2];
  L1[4] = 0.0;
  L1[7] = 0.0;
  L1[2] = 0.0;
  L1[5] = 0.0;
  ...
  /* '<S2>:1:56' */
  /* '<S2>:1:57' */
  rtb_Product_f = 2.2250738585072014E-308;
  rtb_Product_c = fabs(eta_bar_idx_0);
  if (rtb_Product_c > 2.2250738585072014E-308) {
    rtb_Product = 1.0;
    rtb_Product_f = rtb_Product_c;
  } else {
    t = rtb_Product_c / 2.2250738585072014E-308;
    rtb_Product = t * t;
  }

  rtb_Product_c = fabs(eta_bar_idx_1);
  if (rtb_Product_c > rtb_Product_f) {
    t = rtb_Product_f / rtb_Product_c;
    rtb_Product = rtb_Product * t * t + 1.0;
    rtb_Product_f = rtb_Product_c;
  } else {
    t = rtb_Product_c / rtb_Product_f;
    rtb_Product += t * t;
  }

  rtb_Product_c = fabs(eta_bar_idx_2);
  if (rtb_Product_c > rtb_Product_f) {
    t = rtb_Product_f / rtb_Product_c;
    rtb_Product = rtb_Product * t * t + 1.0;
    rtb_Product_f = rtb_Product_c;
  ...
  rtb_Product = rtb_Product_f * sqrt(rtb_Product);
  rtb_Product = rtb_Us - ((-(rtb_Integrator1[0] - eta_bar_idx_0) *
    rtb_eta_ds_idx_0 + -(rtb_Integrator1[1] - eta_bar_idx_1) * rtb_eta_ds_idx_1)
    + -(rtb_Integrator1[2] - eta_bar_idx_2) * 0.0) *
    (ctrl_student_HIL_P.Constant2_Value / rtb_Product);

  /* '<S2>:1:58' */
  /* '<S2>:1:59' */
  /* '<S2>:1:61' */
  tmp[0] = (0.6555 - 0.3545 * fabs(rtb_Integrator_p[0])) - rtb_Integrator_p[0] *
    rtb_Integrator_p[0] * -3.787;
  tmp[3] = 0.0;
  tmp[6] = 0.0;
  tmp[1] = 0.0;
  tmp[4] = ((1.33 - -2.776 * fabs(rtb_Integrator_p[1])) - rtb_Integrator_p[1] *
            rtb_Integrator_p[1] * -64.91) - 0.805 * fabs(rtb_Integrator_p[2]);
  tmp[7] = ((7.25 - -0.845 * fabs(rtb_Integrator_p[1])) - -3.45 * fabs
            (rtb_Integrator_p[2])) - rtb_Integrator_p[2] * rtb_Integrator_p[2] *
    0.0;
  tmp[2] = 0.0;
  tmp[5] = ((-0.0 - -0.2088 * fabs(rtb_Integrator_p[1])) - rtb_Integrator_p[1] *
            rtb_Integrator_p[1] * 0.0) - 0.13 * fabs(rtb_Integrator_p[2]);
  tmp[8] = ((1.9 - 0.08 * fabs(rtb_Integrator_p[1])) - 0.75 * fabs
            (rtb_Integrator_p[2])) - rtb_Integrator_p[2] * rtb_Integrator_p[2] *
    0.0;
  for (i = 0; i < 3; i++) {
    L1_0[i] = ((L1[3 * i + 1] * z1[1] + L1[3 * i] * z1[0]) + L1[3 * i + 2] * z1
               [2]) + rtb_Integrator_p[i];
  }

  for (i = 0; i < 3; i++) {
    b_a_2[i] = R[3 * i + 2] * rtb_Product * 0.0 + (R[3 * i + 1] * rtb_Product *
      rtb_eta_ds_idx_1 + R[3 * i] * rtb_Product * rtb_eta_ds_idx_0);
  }

  rtb_Product_f = L1_0[0] - b_a_2[0];
  rtb_Product_c = L1_0[1] - b_a_2[1];
  t = L1_0[2] - b_a_2[2];
  for (i = 0; i < 3; i++) {
    for (i_0 = 0; i_0 < 3; i_0++) {
      L3[i + 3 * i_0] = 0.0;
      L3[i + 3 * i_0] += L1[3 * i] * R[i_0];
      L3[i + 3 * i_0] += L1[3 * i + 1] * R[i_0 + 3];
      L3[i + 3 * i_0] += L1[3 * i + 2] * R[i_0 + 6];
    }
  }

  for (i = 0; i < 3; i++) {
    L1_0[i] = L3[i + 6] * 0.0 + (L3[i + 3] * rtb_eta_ds_idx_1 + L3[i] *
      rtb_eta_ds_idx_0);
  }

  for (i = 0; i < 3; i++) {
    R_0[i] = R[3 * i + 2] * 0.0 + (R[3 * i + 1] * 0.0 + R[3 * i] * 0.0);
  }

  for (i = 0; i < 3; i++) {
    b_a_2[i] = R[3 * i + 2] * 0.0 + (R[3 * i + 1] * rtb_eta_ds_idx_1 + R[3 * i] *
      rtb_eta_ds_idx_0);
  }

  for (i = 0; i < 3; i++) {
    b_a_1[i] = (((((real_T)b_a_0[i + 3] * rtb_Product_c + (real_T)b_a_0[i] *
                   rtb_Product_f) + (real_T)b_a_0[i + 6] * t) + L1_0[i] * rtb_Us)
                + R_0[i] * rtb_Product * rtb_Us) + b_a_2[i] * 0.0;
  }

  for (i = 0; i < 3; i++) {
    R_0[i] = tmp[i + 6] * rtb_Integrator_p[2] + (tmp[i + 3] * rtb_Integrator_p[1]
      + tmp[i] * rtb_Integrator_p[0]);
  }

  for (i = 0; i < 3; i++) {
    L1_0[i] = a_0[i + 6] * b_a_1[2] + (a_0[i + 3] * b_a_1[1] + a_0[i] * b_a_1[0]);
  }
  ...
  /* '<S17>:1:5' */
  /* '<S17>:1:9' */
  tmp_0[0] = cos(rtb_Integrator1[2]);
  tmp_0[3] = -sin(rtb_Integrator1[2]);
  tmp_0[6] = 0.0;
  tmp_0[1] = sin(rtb_Integrator1[2]);
  tmp_0[4] = cos(rtb_Integrator1[2]);
  tmp_0[7] = 0.0;
  tmp_0[2] = 0.0;
  tmp_0[5] = 0.0;
  tmp_0[8] = 1.0;
  for (i = 0; i < 3; i++) {
    ...
    ctrl_student_HIL_B.eta_dot[i] += tmp_0[i] * rtb_Integrator_p[0];
    ctrl_student_HIL_B.eta_dot[i] += tmp_0[i + 3] * rtb_Integrator_p[1];
    ctrl_student_HIL_B.eta_dot[i] += tmp_0[i + 6] * rtb_Integrator_p[2];
  }
  ...
  /* % Correolis matrix */
  /* '<S18>:1:48' */
  rtb_Product = -15.79 * rtb_Integrator_p[1] - 0.55462499999999992 *
    rtb_Integrator_p[2];

  /* '<S18>:1:49' */
  rtb_Product_f = 16.79 * rtb_Integrator_p[0];
  ...
  tmp_1[1] = 0.0;
  tmp_1[4] = 0.0;
  tmp_1[7] = rtb_Product_f;
  tmp_1[2] = -rtb_Product;
  tmp_1[5] = -rtb_Product_f;
  tmp_1[8] = 0.0;
  tmp_2[0] = (0.6555 - 0.3545 * rtb_Integrator_p[0]) - rtb_Integrator_p[0] *
    rtb_Integrator_p[0] * -3.787;
  tmp_2[3] = (-0.0 - -2.443 * rtb_Integrator_p[1]) - rtb_Integrator_p[1] *
    rtb_Integrator_p[1] * 0.0;
  tmp_2[6] = 0.0;
  tmp_2[1] = 0.0;
  tmp_2[4] = ((1.33 - -2.776 * rtb_Integrator_p[1]) - rtb_Integrator_p[1] *
              rtb_Integrator_p[1] * -64.91) - -0.805 * fabs(rtb_Integrator_p[2]);
  tmp_2[7] = ((7.25 - -3.45 * fabs(rtb_Integrator_p[2])) - rtb_Integrator_p[2] *
              rtb_Integrator_p[2] * 0.0) - -0.845 * fabs(rtb_Integrator_p[1]);
  tmp_2[2] = 0.0;
  tmp_2[5] = ((-0.0 - -0.2088 * rtb_Integrator_p[1]) - rtb_Integrator_p[1] *
              rtb_Integrator_p[1] * 0.0) - 0.13 * fabs(rtb_Integrator_p[2]);
  tmp_2[8] = ((1.9 - -0.75 * fabs(rtb_Integrator_p[2])) - rtb_Integrator_p[2] *
              rtb_Integrator_p[2] * 0.0) - 0.08 * fabs(rtb_Integrator_p[1]);
  for (i = 0; i < 3; i++) {
    tmp[3 * i] = tmp_1[3 * i] + tmp_2[3 * i];
    tmp[1 + 3 * i] = tmp_1[3 * i + 1] + tmp_2[3 * i + 1];
    tmp[2 + 3 * i] = tmp_1[3 * i + 2] + tmp_2[3 * i + 2];
  }

  for (i = 0; i < 3; i++) {
    b_a_2[i] = tmp[i + 6] * rtb_Integrator_p[2] + (tmp[i + 3] *
      rtb_Integrator_p[1] + tmp[i] * rtb_Integrator_p[0]);
  }

  ctrl_student_HIL_B.nu_dot[0] = ((R_0[0] + L1_0[0]) - z1[0]) - b_a_2[0];
  ctrl_student_HIL_B.nu_dot[1] = (((R_0[1] + L1_0[1]) - z1[1]) - b_a_2[1]) -
    ctrl_student_HIL_B.nu_dot[0] * 0.0;
  ctrl_student_HIL_B.nu_dot[2] = ((((R_0[2] + L1_0[2]) - z1[2]) - b_a_2[2]) -
...
void ctrl_student_HIL_derivatives(void)
{
  ...
  _rtXdot->Integrator_CSTATE[0] = ctrl_student_HIL_B.eta_hat_dot[0];
  _rtXdot->Integrator_CSTATE[1] = ctrl_student_HIL_B.eta_hat_dot[1];
  _rtXdot->Integrator_CSTATE[2] = ctrl_student_HIL_B.eta_hat_dot[2];

  /* Derivatives for Integrator: '<S1>/Integrator1' */
  _rtXdot->Integrator1_CSTATE_l[0] = ctrl_student_HIL_B.nu_hat_dot[0];
  _rtXdot->Integrator1_CSTATE_l[1] = ctrl_student_HIL_B.nu_hat_dot[1];
  _rtXdot->Integrator1_CSTATE_l[2] = ctrl_student_HIL_B.nu_hat_dot[2];
  ...
  _rtXdot->Integrator_CSTATE_f = ctrl_student_HIL_B.s_dot;
...
void ctrl_student_HIL_initialize(void)
{
...

  {
    ...
    ctrl_student_HIL_X.Integrator1_CSTATE_l[0] =
      ctrl_student_HIL_P.Integrator1_IC;
    ctrl_student_HIL_X.Integrator1_CSTATE_l[1] =
      ctrl_student_HIL_P.Integrator1_IC;
    ctrl_student_HIL_X.Integrator1_CSTATE_l[2] =
      ctrl_student_HIL_P.Integrator1_IC;
    ...
    ctrl_student_HIL_X.Integrator_CSTATE_f = ctrl_student_HIL_P.Integrator_IC_b;
...
RT_MODEL_ctrl_student_HIL_T *ctrl_student_HIL(void)
{
  ...
  /* Initialize Sizes */
  ctrl_student_HIL_M->Sizes.numContStates = (16);/* Number of continuous states */
  ...
  ctrl_student_HIL_M->Sizes.numBlocks = (95);/* Number of blocks */
  ctrl_student_HIL_M->Sizes.numBlockIO = (48);/* Number of block outputs */
  ctrl_student_HIL_M->Sizes.numBlockPrms = (311);/* Sum of parameter "widths" */
...
void SetExternalInputs(double* data, int* TaskSampleHit)
{
  ...
  // DP Observer /L1_diag
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_student_HIL_B.L1_diag, 0, data[index++], 20, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_B.L1_diag, 1, data[index++], 20, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_B.L1_diag, 2, data[index++], 20, 0);
  } else {
    index += 3;
  }
  ...
  // DP Observer /L2_diag
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_student_HIL_B.L2_diag, 0, data[index++], 20, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_B.L2_diag, 1, data[index++], 20, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_B.L2_diag, 2, data[index++], 20, 0);
  } else {
    index += 3;
  }
  ...
  // DP Observer /L3_diag
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_student_HIL_B.L3_diag, 0, data[index++], 20, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_B.L3_diag, 1, data[index++], 20, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_B.L3_diag, 2, data[index++], 20, 0);
  } else {
    index += 3;
  }
...
void SetExternalOutputs(double* data, int* TaskSampleHit)
{
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_student_HIL_B.Switch,0,19,
      0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_student_HIL_B.Switch,2,19,
      0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_student_HIL_B.Switch,1,19,
      0);
  } else {
    index += 1;
  }
...
int NI_InitExternalOutputs()
{
  ...
  // x_m: Virtual Signal # 0
  ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_student_HIL_B.Switch,0,19,0);

  // psi_m: Virtual Signal # 0
  ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_student_HIL_B.Switch,2,19,0);

  // y_m: Virtual Signal # 0
  ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_student_HIL_B.Switch,1,19,0);
...
static NI_Parameter NI_ParamList[] DataSection(".NIVS.paramlist") =
{
  ...
  { 12, "ctrl_student_hil/Constant1/Value", offsetof(P_ctrl_student_HIL_T,
    Constant1_Value), 34, 1, 2, 24, 0 },

  { 13, "ctrl_student_hil/Noise generator/Sample & hold/Hold/X0", offsetof
    (P_ctrl_student_HIL_T, Hold_X0), 34, 1, 2, 26, 0 },

  { 14, "ctrl_student_hil/DP Observer /Integrator/InitialCondition", offsetof
    (P_ctrl_student_HIL_T, Integrator_IC), 34, 1, 2, 28, 0 },

  { 15, "ctrl_student_hil/DP Observer /Integrator1/InitialCondition", offsetof
    (P_ctrl_student_HIL_T, Integrator1_IC), 34, 1, 2, 30, 0 },

  { 16, "ctrl_student_hil/DP Observer /Memory4/X0", offsetof
    (P_ctrl_student_HIL_T, Memory4_X0), 20, 3, 2, 32, 0 },

  { 17, "ctrl_student_hil/DP Observer /Memory3/X0", offsetof
    (P_ctrl_student_HIL_T, Memory3_X0), 20, 3, 2, 34, 0 },

  { 18, "ctrl_student_hil/DP Observer /Memory2/X0", offsetof
    (P_ctrl_student_HIL_T, Memory2_X0), 20, 3, 2, 36, 0 },

  { 19, "ctrl_student_hil/DP Observer /Integrator2/InitialCondition", offsetof
    (P_ctrl_student_HIL_T, Integrator2_IC), 34, 1, 2, 38, 0 },

  { 20, "ctrl_student_hil/Constant2/Value", offsetof(P_ctrl_student_HIL_T,
    Constant2_Value), 34, 1, 2, 40, 0 },

  { 21, "ctrl_student_hil/Constant3/Value", offsetof(P_ctrl_student_HIL_T,
    Constant3_Value), 17, 9, 2, 42, 0 },

  { 22, "ctrl_student_hil/Constant5/Value", offsetof(P_ctrl_student_HIL_T,
    Constant5_Value), 34, 1, 2, 44, 0 },

  { 23, "ctrl_student_hil/Constant6/Value", offsetof(P_ctrl_student_HIL_T,
    Constant6_Value), 24, 2, 2, 46, 0 },

  { 24, "ctrl_student_hil/Integrator/InitialCondition", offsetof
    (P_ctrl_student_HIL_T, Integrator_IC_b), 34, 1, 2, 48, 0 },

  { 25, "ctrl_student_hil/Subsystem/Integrator/InitialCondition", offsetof
    (P_ctrl_student_HIL_T, Integrator_IC_n), 20, 3, 2, 50, 0 },
  ...
  { 27,
    ...
    offsetof(P_ctrl_student_HIL_T, Constant_Value), 34, 1, 2, 54, 0 },

  { 28,
    "ctrl_student_hil/tau to CSE mocell (only use for HIL testing)/Constant1/Value",
    offsetof(P_ctrl_student_HIL_T, Constant1_Value_h), 34, 1, 2, 56, 0 },
};

static int NI_ParamListSize DataSection(".NIVS.paramlistsize") = 29;
...
static NI_Signal NI_SigList[] DataSection(".NIVS.siglist") =
{
  ...
  { 1, "ctrl_student_hil/noise pos", 0, "", offsetof(B_ctrl_student_HIL_T,
    noisepos)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 2, 0 },
  ...
  { 4, "ctrl_student_hil/noise head", 0, "", offsetof(B_ctrl_student_HIL_T,
    noisehead)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 8, 0 },
  ...
  { 6, "ctrl_student_hil/Reset", 0, "", offsetof(B_ctrl_student_HIL_T, Reset)+0*
    sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 12, 0 },

  { 7, "ctrl_student_hil/Constant1", 0, "", offsetof(B_ctrl_student_HIL_T,
    Constant1)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 14, 0 },

  { 8, "ctrl_student_hil/Noise generator/Sample & hold/Hold", 0, "(1,1)",
    offsetof(B_ctrl_student_HIL_T, Hold)+0*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2,
    16, 0 },

  { 9, "ctrl_student_hil/Noise generator/Sample & hold/Hold", 0, "(1,2)",
    offsetof(B_ctrl_student_HIL_T, Hold)+1*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2,
    18, 0 },

  { 10, "ctrl_student_hil/Noise generator/Sample & hold/Hold", 0, "(1,3)",
    offsetof(B_ctrl_student_HIL_T, Hold)+2*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2,
    20, 0 },
  ...
  { 12, "ctrl_student_hil/Noise generator/Switch", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, Switch)+0*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2, 24,
    0 },

  { 13, "ctrl_student_hil/Noise generator/Switch", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_T, Switch)+1*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2, 26,
    0 },

  { 14, "ctrl_student_hil/Noise generator/Switch", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_T, Switch)+2*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2, 28,
    0 },

  { 15, "ctrl_student_hil/x_in", 0, "", offsetof(B_ctrl_student_HIL_T, x_in)+0*
  ...
  { 19, "ctrl_student_hil/DP Observer /Integrator", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, Integrator)+0*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2,
    38, 0 },

  { 20, "ctrl_student_hil/DP Observer /Integrator", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_T, Integrator)+1*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2,
    40, 0 },

  { 21, "ctrl_student_hil/DP Observer /Integrator", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_T, Integrator)+2*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2,
    42, 0 },

  { 22, "ctrl_student_hil/DP Observer /L1_diag", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, L1_diag)+0*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 44,
    0 },

  { 23, "ctrl_student_hil/DP Observer /L1_diag", 0, "(2,1)", offsetof
    (B_ctrl_student_HIL_T, L1_diag)+1*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 46,
    0 },

  { 24, "ctrl_student_hil/DP Observer /L1_diag", 0, "(3,1)", offsetof
    (B_ctrl_student_HIL_T, L1_diag)+2*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 48,
    0 },

  { 25, "ctrl_student_hil/DP Observer /L2_diag", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, L2_diag)+0*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 50,
    0 },

  { 26, "ctrl_student_hil/DP Observer /L2_diag", 0, "(2,1)", offsetof
    (B_ctrl_student_HIL_T, L2_diag)+1*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 52,
    0 },

  { 27, "ctrl_student_hil/DP Observer /L2_diag", 0, "(3,1)", offsetof
    (B_ctrl_student_HIL_T, L2_diag)+2*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 54,
    0 },

  { 28, "ctrl_student_hil/DP Observer /L3_diag", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, L3_diag)+0*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 56,
    0 },

  { 29, "ctrl_student_hil/DP Observer /L3_diag", 0, "(2,1)", offsetof
    (B_ctrl_student_HIL_T, L3_diag)+1*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 58,
    0 },

  { 30, "ctrl_student_hil/DP Observer /L3_diag", 0, "(3,1)", offsetof
    (B_ctrl_student_HIL_T, L3_diag)+2*sizeof(real_T), BLOCKIO_SIG, 20, 1, 2, 60,
    0 },

  { 31, "ctrl_student_hil/DP Observer /Integrator1", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, Integrator1)+0*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2,
    62, 0 },

  { 32, "ctrl_student_hil/DP Observer /Integrator1", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_T, Integrator1)+1*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2,
    64, 0 },

  { 33, "ctrl_student_hil/DP Observer /Integrator1", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_T, Integrator1)+2*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2,
    66, 0 },

  { 34, "ctrl_student_hil/DP Observer /b", 0, "", offsetof(B_ctrl_student_HIL_T,
    b)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 68, 0 },

  { 35, "ctrl_student_hil/DP Observer /Memory4", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, Memory4)+0*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2, 70,
    0 },

  { 36, "ctrl_student_hil/DP Observer /Memory4", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_T, Memory4)+1*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2, 72,
    0 },

  { 37, "ctrl_student_hil/DP Observer /Memory4", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_T, Memory4)+2*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2, 74,
    0 },

  { 38, "ctrl_student_hil/DP Observer /Memory3", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, Memory3)+0*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2, 76,
    0 },

  { 39, "ctrl_student_hil/DP Observer /Memory3", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_T, Memory3)+1*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2, 78,
    0 },

  { 40, "ctrl_student_hil/DP Observer /Memory3", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_T, Memory3)+2*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2, 80,
    0 },

  { 41, "ctrl_student_hil/DP Observer /Memory2", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, Memory2)+0*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2, 82,
    0 },

  { 42, "ctrl_student_hil/DP Observer /Memory2", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_T, Memory2)+1*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2, 84,
    0 },

  { 43, "ctrl_student_hil/DP Observer /Memory2", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_T, Memory2)+2*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2, 86,
    0 },

  { 44, "ctrl_student_hil/DP Observer /Integrator2", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, Integrator2)+0*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2,
    88, 0 },

  { 45, "ctrl_student_hil/DP Observer /Integrator2", 0, "(1,2)", offsetof
    (B_ctrl_student_HIL_T, Integrator2)+1*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2,
    90, 0 },

  { 46, "ctrl_student_hil/DP Observer /Integrator2", 0, "(1,3)", offsetof
    (B_ctrl_student_HIL_T, Integrator2)+2*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2,
    92, 0 },

  { 47, "ctrl_student_hil/joystick/L2_continuous", 0, "", offsetof
    (B_ctrl_student_HIL_T, L2_continuous)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    94, 0 },

  { 48, "ctrl_student_hil/joystick/PosXRight", 0, "", offsetof
    (B_ctrl_student_HIL_T, PosXRight)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 96,
    0 },

  { 49, "ctrl_student_hil/joystick/PosYRight", 0, "", offsetof
    (B_ctrl_student_HIL_T, PosYRight)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 98,
    0 },

  { 50, "ctrl_student_hil/joystick/R2_continuous", 0, "", offsetof
    (B_ctrl_student_HIL_T, R2_continuous)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    100, 0 },

  { 51, "ctrl_student_hil/joystick/PosXLeft", 0, "", offsetof
    (B_ctrl_student_HIL_T, PosXLeft)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 102,
    0 },

  { 52, "ctrl_student_hil/joystick/PosYLeft", 0, "", offsetof
    (B_ctrl_student_HIL_T, PosYLeft)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 104,
    0 },

  { 53, "ctrl_student_hil/joystick/L1", 0, "", offsetof(B_ctrl_student_HIL_T, L1)
    +0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 106, 0 },

  { 54, "ctrl_student_hil/joystick/R1", 0, "", offsetof(B_ctrl_student_HIL_T, R1)
    +0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 108, 0 },

  { 55, "ctrl_student_hil/joystick/ArrowDown", 0, "", offsetof
    (B_ctrl_student_HIL_T, ArrowDown)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    110, 0 },

  { 56, "ctrl_student_hil/joystick/ArrowUp", 0, "", offsetof
    (B_ctrl_student_HIL_T, ArrowUp)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 112,
    0 },

  { 57, "ctrl_student_hil/joystick/ArrowLeft", 0, "", offsetof
    (B_ctrl_student_HIL_T, ArrowLeft)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    114, 0 },

  { 58, "ctrl_student_hil/joystick/ArrowRight", 0, "", offsetof
    (B_ctrl_student_HIL_T, ArrowRight)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    116, 0 },

  { 59, "ctrl_student_hil/Subsystem/kinetics", 0, "nu_dot(1,1)", offsetof
    (B_ctrl_student_HIL_T, nu_dot)+0*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2, 118,
    0 },

  { 60, "ctrl_student_hil/Subsystem/kinetics", 0, "nu_dot(1,2)", offsetof
    (B_ctrl_student_HIL_T, nu_dot)+1*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2, 120,
    0 },

  { 61, "ctrl_student_hil/Subsystem/kinetics", 0, "nu_dot(1,3)", offsetof
    (B_ctrl_student_HIL_T, nu_dot)+2*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2, 122,
    0 },

  { 62, "ctrl_student_hil/Subsystem/kinematics", 0, "eta_dot(1,1)", offsetof
    (B_ctrl_student_HIL_T, eta_dot)+0*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2, 124,
    0 },

  { 63, "ctrl_student_hil/Subsystem/kinematics", 0, "eta_dot(1,2)", offsetof
    (B_ctrl_student_HIL_T, eta_dot)+1*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2, 126,
    0 },

  { 64, "ctrl_student_hil/Subsystem/kinematics", 0, "eta_dot(1,3)", offsetof
    (B_ctrl_student_HIL_T, eta_dot)+2*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2, 128,
    0 },
  ...
  { 68, "ctrl_student_hil/Noise generator/Downsamplesignal/MATLAB Function", 0,
    "count", offsetof(B_ctrl_student_HIL_T, count)+0*sizeof(real_T), BLOCKIO_SIG,
    0, 1, 2, 136, 0 },

  { 69, "ctrl_student_hil/MATLAB Function", 1, "s_dot", offsetof
    (B_ctrl_student_HIL_T, s_dot)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 138, 0
  },

  { 70, "ctrl_student_hil/DP Observer /Observer", 0, "eta_hat_dot(1,1)",
    offsetof(B_ctrl_student_HIL_T, eta_hat_dot)+0*sizeof(real_T), BLOCKIO_SIG,
    19, 1, 2, 140, 0 },

  { 71, "ctrl_student_hil/DP Observer /Observer", 0, "eta_hat_dot(1,2)",
    offsetof(B_ctrl_student_HIL_T, eta_hat_dot)+1*sizeof(real_T), BLOCKIO_SIG,
    19, 1, 2, 142, 0 },

  { 72, "ctrl_student_hil/DP Observer /Observer", 0, "eta_hat_dot(1,3)",
    offsetof(B_ctrl_student_HIL_T, eta_hat_dot)+2*sizeof(real_T), BLOCKIO_SIG,
    19, 1, 2, 144, 0 },

  { 73, "ctrl_student_hil/DP Observer /Observer", 1, "nu_hat_dot(1,1)", offsetof
    (B_ctrl_student_HIL_T, nu_hat_dot)+0*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2,
    146, 0 },

  { 74, "ctrl_student_hil/DP Observer /Observer", 1, "nu_hat_dot(1,2)", offsetof
    (B_ctrl_student_HIL_T, nu_hat_dot)+1*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2,
    148, 0 },

  { 75, "ctrl_student_hil/DP Observer /Observer", 1, "nu_hat_dot(1,3)", offsetof
    (B_ctrl_student_HIL_T, nu_hat_dot)+2*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2,
    150, 0 },

  { 76, "ctrl_student_hil/DP Observer /Observer", 2, "b_hat_dot(1,1)", offsetof
    (B_ctrl_student_HIL_T, b_hat_dot)+0*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2,
    152, 0 },

  { 77, "ctrl_student_hil/DP Observer /Observer", 2, "b_hat_dot(1,2)", offsetof
    (B_ctrl_student_HIL_T, b_hat_dot)+1*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2,
    154, 0 },

  { 78, "ctrl_student_hil/DP Observer /Observer", 2, "b_hat_dot(1,3)", offsetof
    (B_ctrl_student_HIL_T, b_hat_dot)+2*sizeof(real_T), BLOCKIO_SIG, 19, 1, 2,
    156, 0 },

  { 79, "ctrl_student_hil/DP Observer /Observer", 3, "x_bar", offsetof
    (B_ctrl_student_HIL_T, x_bar)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 158, 0
  },

  { 80, "ctrl_student_hil/DP Observer /Observer", 4, "y_bar", offsetof
    (B_ctrl_student_HIL_T, y_bar)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 160, 0
  },

  { 81, "ctrl_student_hil/DP Observer /Observer", 5, "psi_bar", offsetof
    (B_ctrl_student_HIL_T, psi_bar)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 162,
    0 },

  { -1, "", -1, "", 0, 0, 0 }
};

static int NI_SigListSize DataSection(".NIVS.siglistsize") = 82;
...
static NI_ExternalIO NI_ExtList[] DataSection(".NIVS.extlist") =
{
  ...
  { 1, "noise pos", 0, EXT_IN, 1, 1, 1 },

  { 2, "noise head", 0, EXT_IN, 1, 1, 1 },

  { 3, "Reset", 0, EXT_IN, 1, 1, 1 },

  { 4, "enable noise", 0, EXT_IN, 1, 1, 1 },

  { 5, "x_in", 1, EXT_IN, 1, 1, 1 },
  ...
  { 12, "tau to CSE mocell (only use for HIL testing)/X_d", 1, EXT_OUT, 1, 1, 1
  },
...
static char* NI_CompiledModelDateTime = "Fri Mar 24 10:37:00 2017";
  ...
  * discStates, long* numClockTicks, char* clockTicksNames, long* clockTicks)
{
  ...
  if (contStates && contStatesNames) {
    ...
    strcpy(contStatesNames + (idx++ * 100), "Integrator_CSTATE");
    contStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_X.Integrator1_CSTATE_l[0], 0, 0, 0);
    strcpy(contStatesNames + (idx++ * 100), "Integrator1_CSTATE_l");
    contStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_X.Integrator1_CSTATE_l[0], 1, 0, 0);
    strcpy(contStatesNames + (idx++ * 100), "Integrator1_CSTATE_l");
    contStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_X.Integrator1_CSTATE_l[0], 2, 0, 0);
    strcpy(contStatesNames + (idx++ * 100), "Integrator1_CSTATE_l");
    contStates[idx] = NIRT_GetValueByDataType
  ...
  if (discStates && discStatesNames) {
    ...
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_DW.Hold_PreviousInput, 0, 19, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_DW.Hold_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_DW.Hold_PreviousInput, 1, 19, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_DW.Hold_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_DW.Hold_PreviousInput, 2, 19, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_DW.Hold_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
    ...
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_DW.L1_diag_DWORK1, 0, 19, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_DW.L1_diag_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_DW.L1_diag_DWORK1, 1, 19, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_DW.L1_diag_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_DW.L1_diag_DWORK1, 2, 19, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_DW.L1_diag_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
    ...
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_DW.L2_diag_DWORK1, 0, 19, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_DW.L2_diag_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_DW.L2_diag_DWORK1, 1, 19, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_DW.L2_diag_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_DW.L2_diag_DWORK1, 2, 19, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_DW.L2_diag_DWORK1");
    ...
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_DW.L3_diag_DWORK1, 0, 19, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_DW.L3_diag_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_DW.L3_diag_DWORK1, 1, 19, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_DW.L3_diag_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_DW.L3_diag_DWORK1, 2, 19, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_DW.L3_diag_DWORK1");
    ...
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_DW.Memory4_PreviousInput, 0, 19, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_DW.Memory4_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_DW.Memory4_PreviousInput, 1, 19, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_DW.Memory4_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_DW.Memory4_PreviousInput, 2, 19, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_DW.Memory4_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_DW.Memory3_PreviousInput, 0, 19, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_DW.Memory3_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_DW.Memory3_PreviousInput, 1, 19, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_DW.Memory3_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_DW.Memory3_PreviousInput, 2, 19, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_DW.Memory3_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_DW.Memory2_PreviousInput, 0, 19, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_DW.Memory2_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_DW.Memory2_PreviousInput, 1, 19, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_DW.Memory2_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_DW.Memory2_PreviousInput, 2, 19, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_student_HIL_DW.Memory2_PreviousInput");
    ...
    for (count = 0; count < 17; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_DW.noisepos_DWORK2, count, 21, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 17; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_DW.noisehead_DWORK2, count, 21, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 17; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_DW.Reset_DWORK2, count, 21, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 17; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_DW.L1_diag_DWORK2, count, 21, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 17; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_DW.L2_diag_DWORK2, count, 21, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 17; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_DW.L3_diag_DWORK2, count, 21, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 17; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_DW.r_dot_DWORK2, count, 21, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 17; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_DW.u_dot_DWORK2, count, 21, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 17; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_DW.v_dot_DWORK2, count, 21, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 17; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_DW.y_bar_DWORK2, count, 21, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 17; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_DW.psi_bar_DWORK2, count, 21, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 17; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_student_HIL_DW.x_bar_DWORK2, count, 21, 0);
      strcpy(discStatesNames + (idx++ * 100),
  ...
  * clockTicks)
{
  ...
  if (contStates) {
    ...
    NIRT_SetValueByDataType(&ctrl_student_HIL_X.Integrator_CSTATE[0], 2,
      contStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_X.Integrator1_CSTATE_l[0], 0,
      contStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_X.Integrator1_CSTATE_l[0], 1,
      contStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_student_HIL_X.Integrator1_CSTATE_l[0], 2,
      contStates[idx++], 0, 0);
