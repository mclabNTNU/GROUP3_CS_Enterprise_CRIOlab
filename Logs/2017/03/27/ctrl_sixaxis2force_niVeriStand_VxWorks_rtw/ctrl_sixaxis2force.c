 ...
 * C source code generated on : Mon Mar 27 11:29:16 2017
 *
...
RT_MODEL_ctrl_sixaxis2force_T *ctrl_sixaxis2force(void)
{
  ...
  ctrl_sixaxis2force_M->Sizes.numBlocks = (20);/* Number of blocks */
  ctrl_sixaxis2force_M->Sizes.numBlockIO = (9);/* Number of block outputs */
  ctrl_sixaxis2force_M->Sizes.numBlockPrms = (76);/* Sum of parameter "widths" */
...
static NI_Signal NI_SigList[] DataSection(".NIVS.siglist") =
{
  ...
  { 4, "ctrl_sixaxis2force/alfa_calb", 0, "", offsetof(B_ctrl_sixaxis2force_T,
    alfa_calb)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 8, 0 },

  { 5, "ctrl_sixaxis2force/Sum1", 0, "", offsetof(B_ctrl_sixaxis2force_T, Sum1)+
    0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 10, 0 },

  { 6, "ctrl_sixaxis2force/Thrust allocation", 0, "u_BT", offsetof
    (B_ctrl_sixaxis2force_T, u_BT)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 12, 0
  },

  { 7, "ctrl_sixaxis2force/Thrust allocation", 1, "u_VSP", offsetof
    (B_ctrl_sixaxis2force_T, u_VSP)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 14,
    0 },

  { 8, "ctrl_sixaxis2force/Thrust allocation", 3, "omega_VSP", offsetof
...
static char* NI_CompiledModelName DataSection(".NIVS.compiledmodelname") =
  "ctrl_sixaxis2force";
static char* NI_CompiledModelVersion = "1.35";
static char* NI_CompiledModelDateTime = "Mon Mar 27 11:29:16 2017";
