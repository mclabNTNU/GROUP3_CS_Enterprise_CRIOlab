...
void ctrl_student_HIL_output(void)
{
  ...
  ctrl_student_HIL_B.y = -((0.6555 - 0.3545 * fabs(psi_d)) + psi_d * psi_d *
    3.787) * psi_d / 14.79 - k_psi * t * psi_d;
...
RT_MODEL_ctrl_student_HIL_T *ctrl_student_HIL(void)
{
  ...
  ctrl_student_HIL_M->Sizes.numBlocks = (148);/* Number of blocks */
  ctrl_student_HIL_M->Sizes.numBlockIO = (66);/* Number of block outputs */
...
void SetExternalOutputs(double* data, int* TaskSampleHit)
{
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_B.MultiportSwitch,5,24,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_B.MultiportSwitch,3,24,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_B.MultiportSwitch,4,24,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_B.MultiportSwitch,2,24,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_B.MultiportSwitch,0,24,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType
      (&ctrl_student_HIL_B.MultiportSwitch,1,24,0);
  } else {
    index += 1;
  }
...
static NI_Parameter NI_ParamList[] DataSection(".NIVS.paramlist") =
{
  ...
  { 4, "ctrl_student_hil/DP_along_line/Line Mapper/P_d/Value", offsetof
    (P_ctrl_student_HIL_T, P_d), 22, 4, 2, 8, 0 },

  { 5, "ctrl_student_hil/DP_along_line/Line Speed Gauge/Constant/Value",
    offsetof(P_ctrl_student_HIL_T, P_d), 22, 4, 2, 10, 0 },

  { 6, "ctrl_student_hil/Manuvering_along_line/Line Mapper/P_d/Value", offsetof
    (P_ctrl_student_HIL_T, P_d), 22, 4, 2, 12, 0 },

  { 7, "ctrl_student_hil/Manuvering_along_line/Line Speed Gauge/Constant/Value",
    offsetof(P_ctrl_student_HIL_T, P_d), 22, 4, 2, 14, 0 },

  { 8, "ctrl_student_hil/Ellipse/Ellipse Mapper /R/Value", offsetof
    (P_ctrl_student_HIL_T, R), 22, 4, 2, 16, 0 },
  ...
  { 11, "ctrl_student_hil/Ellipse/Ellipse Speed Gauge/Constant/Value", offsetof
    (P_ctrl_student_HIL_T, r), 29, 2, 2, 22, 0 },

  { 12, "ctrl_student_hil/Constant3/Value", offsetof(P_ctrl_student_HIL_T,
    Constant3_Value), 45, 1, 2, 24, 0 },

  { 13, "ctrl_student_hil/Dead reconing/Memory/X0", offsetof
    (P_ctrl_student_HIL_T, Memory_X0), 21, 9, 2, 26, 0 },

  { 14, "ctrl_student_hil/Dead reconing/Integrator, Second-Order/ICX", offsetof
    (P_ctrl_student_HIL_T, IntegratorSecondOrder_ICX), 45, 1, 2, 28, 0 },

  { 15, "ctrl_student_hil/Dead reconing/Integrator, Second-Order/ICDXDT",
    offsetof(P_ctrl_student_HIL_T, IntegratorSecondOrder_ICDXDT), 45, 1, 2, 30,
    0 },

  { 16, "ctrl_student_hil/Ellipse/Update Law/Integrator/InitialCondition",
    offsetof(P_ctrl_student_HIL_T, Integrator_IC), 45, 1, 2, 32, 0 },

  { 17, "ctrl_student_hil/Ellipse/Update Law/Saturation/UpperLimit", offsetof
    (P_ctrl_student_HIL_T, Saturation_UpperSat), 45, 1, 2, 34, 0 },

  { 18, "ctrl_student_hil/Ellipse/Update Law/Saturation/LowerLimit", offsetof
    (P_ctrl_student_HIL_T, Saturation_LowerSat), 45, 1, 2, 36, 0 },

  { 19, "ctrl_student_hil/Ellipse/Control law1/Saturation/UpperLimit", offsetof
    (P_ctrl_student_HIL_T, Saturation_UpperSat_d), 18, 3, 2, 38, 0 },

  { 20, "ctrl_student_hil/Ellipse/Control law1/Saturation/LowerLimit", offsetof
    (P_ctrl_student_HIL_T, Saturation_LowerSat_h), 18, 3, 2, 40, 0 },

  { 21,
    "ctrl_student_hil/Manuvering_along_line/Update Law/Integrator/InitialCondition",
    offsetof(P_ctrl_student_HIL_T, Integrator_IC_l), 45, 1, 2, 42, 0 },

  { 22,
    "ctrl_student_hil/Manuvering_along_line/Update Law/Integrator/UpperSaturationLimit",
    offsetof(P_ctrl_student_HIL_T, Integrator_UpperSat), 45, 1, 2, 44, 0 },

  { 23,
    "ctrl_student_hil/Manuvering_along_line/Update Law/Integrator/LowerSaturationLimit",
    offsetof(P_ctrl_student_HIL_T, Integrator_LowerSat), 45, 1, 2, 46, 0 },

  { 24,
    "ctrl_student_hil/Manuvering_along_line/Update Law/Saturation/UpperLimit",
    offsetof(P_ctrl_student_HIL_T, Saturation_UpperSat_a), 45, 1, 2, 48, 0 },

  { 25,
    "ctrl_student_hil/Manuvering_along_line/Update Law/Saturation/LowerLimit",
    offsetof(P_ctrl_student_HIL_T, Saturation_LowerSat_n), 45, 1, 2, 50, 0 },

  { 26,
    "ctrl_student_hil/Manuvering_along_line/Control law/Saturation/UpperLimit",
    offsetof(P_ctrl_student_HIL_T, Saturation_UpperSat_f), 18, 3, 2, 52, 0 },

  { 27,
    "ctrl_student_hil/Manuvering_along_line/Control law/Saturation/LowerLimit",
    offsetof(P_ctrl_student_HIL_T, Saturation_LowerSat_f), 18, 3, 2, 54, 0 },

  { 28, "ctrl_student_hil/DP_along_line/Update Law1/Integrator/InitialCondition",
    offsetof(P_ctrl_student_HIL_T, Integrator_IC_m), 45, 1, 2, 56, 0 },

  { 29,
    "ctrl_student_hil/DP_along_line/Update Law1/Integrator/UpperSaturationLimit",
    offsetof(P_ctrl_student_HIL_T, Integrator_UpperSat_a), 45, 1, 2, 58, 0 },

  { 30,
    "ctrl_student_hil/DP_along_line/Update Law1/Integrator/LowerSaturationLimit",
    offsetof(P_ctrl_student_HIL_T, Integrator_LowerSat_f), 45, 1, 2, 60, 0 },

  { 31, "ctrl_student_hil/DP_along_line/Line Mapper/Memory/X0", offsetof
    (P_ctrl_student_HIL_T, Memory_X0_b), 45, 1, 2, 62, 0 },

  { 32, "ctrl_student_hil/DP_along_line/Update Law1/Saturation/UpperLimit",
    offsetof(P_ctrl_student_HIL_T, Saturation_UpperSat_c), 45, 1, 2, 64, 0 },

  { 33, "ctrl_student_hil/DP_along_line/Update Law1/Saturation/LowerLimit",
    offsetof(P_ctrl_student_HIL_T, Saturation_LowerSat_nv), 45, 1, 2, 66, 0 },

  { 34, "ctrl_student_hil/DP_along_line/Constant1/Value", offsetof
    (P_ctrl_student_HIL_T, Constant1_Value), 45, 1, 2, 68, 0 },

  { 35, "ctrl_student_hil/DP_along_line/Constant/Value", offsetof
    (P_ctrl_student_HIL_T, Constant_Value), 18, 3, 2, 70, 0 },

  { 36, "ctrl_student_hil/DP_along_line/Control law1/Saturation/UpperLimit",
    offsetof(P_ctrl_student_HIL_T, Saturation_UpperSat_b), 18, 3, 2, 72, 0 },

  { 37, "ctrl_student_hil/DP_along_line/Control law1/Saturation/LowerLimit",
    offsetof(P_ctrl_student_HIL_T, Saturation_LowerSat_c), 18, 3, 2, 74, 0 },

  { 38, "ctrl_student_hil/DP Observer /Memory4/X0", offsetof
    (P_ctrl_student_HIL_T, Memory4_X0), 18, 3, 2, 76, 0 },

  { 39, "ctrl_student_hil/DP Observer /Memory3/X0", offsetof
    (P_ctrl_student_HIL_T, Memory3_X0), 18, 3, 2, 78, 0 },

  { 40, "ctrl_student_hil/DP Observer /Memory2/X0", offsetof
    (P_ctrl_student_HIL_T, Memory2_X0), 18, 3, 2, 80, 0 },

  { 41, "ctrl_student_hil/DP Observer /Integrator/InitialCondition", offsetof
    (P_ctrl_student_HIL_T, Integrator_IC_d), 45, 1, 2, 82, 0 },

  { 42, "ctrl_student_hil/DP Observer /Integrator1/InitialCondition", offsetof
    (P_ctrl_student_HIL_T, Integrator1_IC), 45, 1, 2, 84, 0 },

  { 43, "ctrl_student_hil/DP Observer /Integrator2/InitialCondition", offsetof
    (P_ctrl_student_HIL_T, Integrator2_IC), 45, 1, 2, 86, 0 },

  { 44, "ctrl_student_hil/SurgeObserver /Constant/Value", offsetof
    (P_ctrl_student_HIL_T, Constant_Value_b), 45, 1, 2, 88, 0 },

  { 45,
    "ctrl_student_hil/tau to CSE mocell (only use for HIL testing)/Constant2/Value",
    offsetof(P_ctrl_student_HIL_T, Constant2_Value), 45, 1, 2, 90, 0 },

  { 46,
    "ctrl_student_hil/tau to CSE mocell (only use for HIL testing)/Constant/Value",
    offsetof(P_ctrl_student_HIL_T, Constant_Value_i), 45, 1, 2, 92, 0 },

  { 47,
    "ctrl_student_hil/tau to CSE mocell (only use for HIL testing)/Constant1/Value",
    offsetof(P_ctrl_student_HIL_T, Constant1_Value_h), 45, 1, 2, 94, 0 },
};
...
static NI_Signal NI_SigList[] DataSection(".NIVS.siglist") =
{
  ...
  { 21, "ctrl_student_hil/Manuvering_along_line/Control law/Saturation", 0,
    "(1,1)", offsetof(B_ctrl_student_HIL_T, Saturation_o)+0*sizeof(real_T),
    BLOCKIO_SIG, 17, 1, 2, 42, 0 },

  { 22, "ctrl_student_hil/Manuvering_along_line/Control law/Saturation", 0,
    "(1,2)", offsetof(B_ctrl_student_HIL_T, Saturation_o)+1*sizeof(real_T),
    BLOCKIO_SIG, 17, 1, 2, 44, 0 },

  { 23, "ctrl_student_hil/Manuvering_along_line/Control law/Saturation", 0,
  ...
  { 27, "ctrl_student_hil/DP_along_line/Control law1/Saturation", 0, "(1,1)",
    offsetof(B_ctrl_student_HIL_T, Saturation_m)+0*sizeof(real_T), BLOCKIO_SIG,
    17, 1, 2, 54, 0 },

  { 28, "ctrl_student_hil/DP_along_line/Control law1/Saturation", 0, "(1,2)",
    offsetof(B_ctrl_student_HIL_T, Saturation_m)+1*sizeof(real_T), BLOCKIO_SIG,
    17, 1, 2, 56, 0 },

  { 29, "ctrl_student_hil/DP_along_line/Control law1/Saturation", 0, "(1,3)",
  ...
  { 30, "ctrl_student_hil/Multiport Switch", 0, "(1,1)", offsetof
    (B_ctrl_student_HIL_T, MultiportSwitch)+0*sizeof(real_T), BLOCKIO_SIG, 24, 1,
    2, 60, 0 },

  { 31, "ctrl_student_hil/Multiport Switch", 0, "(2,1)", offsetof
    (B_ctrl_student_HIL_T, MultiportSwitch)+1*sizeof(real_T), BLOCKIO_SIG, 24, 1,
    2, 62, 0 },

  { 32, "ctrl_student_hil/Multiport Switch", 0, "(3,1)", offsetof
    (B_ctrl_student_HIL_T, MultiportSwitch)+2*sizeof(real_T), BLOCKIO_SIG, 24, 1,
    2, 64, 0 },

  { 33, "ctrl_student_hil/Multiport Switch", 0, "(4,1)", offsetof
    (B_ctrl_student_HIL_T, MultiportSwitch)+3*sizeof(real_T), BLOCKIO_SIG, 24, 1,
    2, 66, 0 },

  { 34, "ctrl_student_hil/Multiport Switch", 0, "(5,1)", offsetof
    (B_ctrl_student_HIL_T, MultiportSwitch)+4*sizeof(real_T), BLOCKIO_SIG, 24, 1,
    2, 68, 0 },

  { 35, "ctrl_student_hil/Multiport Switch", 0, "(6,1)", offsetof
    (B_ctrl_student_HIL_T, MultiportSwitch)+5*sizeof(real_T), BLOCKIO_SIG, 24, 1,
    2, 70, 0 },
  ...
  { 82, "ctrl_student_hil/Ellipse/Control law1/MATLAB Function", 0, "tau(1,1)",
    offsetof(B_ctrl_student_HIL_T, tau)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    164, 0 },

  { 83, "ctrl_student_hil/Ellipse/Control law1/MATLAB Function", 0, "tau(1,2)",
    offsetof(B_ctrl_student_HIL_T, tau)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    166, 0 },

  { 84, "ctrl_student_hil/Ellipse/Control law1/MATLAB Function", 0, "tau(1,3)",
    offsetof(B_ctrl_student_HIL_T, tau)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    168, 0 },

  { 85, "ctrl_student_hil/Dead reconing/MATLAB Function", 0, "dead_x", offsetof
    (B_ctrl_student_HIL_T, dead_x)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 170,
    0 },

  { 86, "ctrl_student_hil/Dead reconing/MATLAB Function", 1, "newmem(1,1)",
    offsetof(B_ctrl_student_HIL_T, newmem)+0*sizeof(real_T), BLOCKIO_SIG, 21, 1,
    2, 172, 0 },

  { 87, "ctrl_student_hil/Dead reconing/MATLAB Function", 1, "newmem(2,1)",
    offsetof(B_ctrl_student_HIL_T, newmem)+1*sizeof(real_T), BLOCKIO_SIG, 21, 1,
    2, 174, 0 },

  { 88, "ctrl_student_hil/Dead reconing/MATLAB Function", 1, "newmem(3,1)",
    offsetof(B_ctrl_student_HIL_T, newmem)+2*sizeof(real_T), BLOCKIO_SIG, 21, 1,
    2, 176, 0 },

  { 89, "ctrl_student_hil/Dead reconing/MATLAB Function", 1, "newmem(1,2)",
    offsetof(B_ctrl_student_HIL_T, newmem)+3*sizeof(real_T), BLOCKIO_SIG, 21, 1,
    2, 178, 0 },

  { 90, "ctrl_student_hil/Dead reconing/MATLAB Function", 1, "newmem(2,2)",
    offsetof(B_ctrl_student_HIL_T, newmem)+4*sizeof(real_T), BLOCKIO_SIG, 21, 1,
    2, 180, 0 },

  { 91, "ctrl_student_hil/Dead reconing/MATLAB Function", 1, "newmem(3,2)",
    offsetof(B_ctrl_student_HIL_T, newmem)+5*sizeof(real_T), BLOCKIO_SIG, 21, 1,
    2, 182, 0 },

  { 92, "ctrl_student_hil/Dead reconing/MATLAB Function", 1, "newmem(1,3)",
    offsetof(B_ctrl_student_HIL_T, newmem)+6*sizeof(real_T), BLOCKIO_SIG, 21, 1,
    2, 184, 0 },

  { 93, "ctrl_student_hil/Dead reconing/MATLAB Function", 1, "newmem(2,3)",
    offsetof(B_ctrl_student_HIL_T, newmem)+7*sizeof(real_T), BLOCKIO_SIG, 21, 1,
    2, 186, 0 },

  { 94, "ctrl_student_hil/Dead reconing/MATLAB Function", 1, "newmem(3,3)",
    offsetof(B_ctrl_student_HIL_T, newmem)+8*sizeof(real_T), BLOCKIO_SIG, 21, 1,
    2, 188, 0 },

  { 95, "ctrl_student_hil/DP_along_line/Line Mapper/MATLAB Function", 2,
    "s_proc", offsetof(B_ctrl_student_HIL_T, s_proc)+0*sizeof(real_T),
    BLOCKIO_SIG, 0, 1, 2, 190, 0 },

  { 96, "ctrl_student_hil/DP Observer /Observer", 0, "eta_hat_dot(1,1)",
    offsetof(B_ctrl_student_HIL_T, eta_hat_dot)+0*sizeof(real_T), BLOCKIO_SIG,
    17, 1, 2, 192, 0 },

  { 97, "ctrl_student_hil/DP Observer /Observer", 0, "eta_hat_dot(1,2)",
    offsetof(B_ctrl_student_HIL_T, eta_hat_dot)+1*sizeof(real_T), BLOCKIO_SIG,
    17, 1, 2, 194, 0 },

  { 98, "ctrl_student_hil/DP Observer /Observer", 0, "eta_hat_dot(1,3)",
    offsetof(B_ctrl_student_HIL_T, eta_hat_dot)+2*sizeof(real_T), BLOCKIO_SIG,
    17, 1, 2, 196, 0 },

  { 99, "ctrl_student_hil/DP Observer /Observer", 1, "nu_hat_dot(1,1)", offsetof
    (B_ctrl_student_HIL_T, nu_hat_dot)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    198, 0 },

  { 100, "ctrl_student_hil/DP Observer /Observer", 1, "nu_hat_dot(1,2)",
    offsetof(B_ctrl_student_HIL_T, nu_hat_dot)+1*sizeof(real_T), BLOCKIO_SIG, 17,
    1, 2, 200, 0 },

  { 101, "ctrl_student_hil/DP Observer /Observer", 1, "nu_hat_dot(1,3)",
    offsetof(B_ctrl_student_HIL_T, nu_hat_dot)+2*sizeof(real_T), BLOCKIO_SIG, 17,
    1, 2, 202, 0 },

  { 102, "ctrl_student_hil/DP Observer /Observer", 2, "b_hat_dot(1,1)", offsetof
    (B_ctrl_student_HIL_T, b_hat_dot)+0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    204, 0 },

  { 103, "ctrl_student_hil/DP Observer /Observer", 2, "b_hat_dot(1,2)", offsetof
    (B_ctrl_student_HIL_T, b_hat_dot)+1*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    206, 0 },

  { 104, "ctrl_student_hil/DP Observer /Observer", 2, "b_hat_dot(1,3)", offsetof
    (B_ctrl_student_HIL_T, b_hat_dot)+2*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2,
    208, 0 },

  { 105, "ctrl_student_hil/DP Observer /Observer", 3, "x_bar", offsetof
    (B_ctrl_student_HIL_T, x_bar)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 210, 0
  },

  { 106, "ctrl_student_hil/DP Observer /Observer", 4, "y_bar", offsetof
    (B_ctrl_student_HIL_T, y_bar)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 212, 0
  },

  { 107, "ctrl_student_hil/DP Observer /Observer", 5, "psi_bar", offsetof
    (B_ctrl_student_HIL_T, psi_bar)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 214,
    0 },
  ...
  { 112, "ctrl_student_hil/Manuvering_along_line/Control law/MATLAB Function2",
    ...
    sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 224, 0 },
  ...
  { 113, "ctrl_student_hil/Manuvering_along_line/Control law/MATLAB Function2",
    ...
    sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 226, 0 },
  ...
  { 131, "ctrl_student_hil/DP_along_line/Control law1/MATLAB Function1", 0,
    ...
    +0*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 262, 0 },
  ...
  { 132, "ctrl_student_hil/DP_along_line/Control law1/MATLAB Function1", 0,
    ...
    +1*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 264, 0 },
  ...
  { 133, "ctrl_student_hil/DP_along_line/Control law1/MATLAB Function1", 0,
    ...
    +2*sizeof(real_T), BLOCKIO_SIG, 17, 1, 2, 266, 0 },
  ...
  { 134, "ctrl_student_hil/DP_along_line/Control law1/MATLAB Function", 0,
    ...
    (real_T), BLOCKIO_SIG, 17, 1, 2, 268, 0 },
  ...
  { 135, "ctrl_student_hil/DP_along_line/Control law1/MATLAB Function", 0,
    ...
    (real_T), BLOCKIO_SIG, 17, 1, 2, 270, 0 },
  ...
  { 136, "ctrl_student_hil/DP_along_line/Control law1/MATLAB Function", 0,
    ...
    (real_T), BLOCKIO_SIG, 17, 1, 2, 272, 0 },
...
static char* NI_CompiledModelName DataSection(".NIVS.compiledmodelname") =
  "ctrl_student_hil";
static char* NI_CompiledModelVersion = "1.299";
static char* NI_CompiledModelDateTime = "Sat Mar 25 14:33:18 2017";
