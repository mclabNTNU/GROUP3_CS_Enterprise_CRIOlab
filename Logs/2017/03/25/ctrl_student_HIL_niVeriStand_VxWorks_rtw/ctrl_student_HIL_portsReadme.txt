...
<outport> id = "-1" name = "psi_d" width = "1" datatype = "24"</outport>
<outport> id = "-1" name = "x_d" width = "1" datatype = "24"</outport>
<outport> id = "-1" name = "y_d" width = "1" datatype = "24"</outport>
...
<outport> id = "-1" name = "tau to CSE mocell (only use for HIL testing)/N_d" width = "1" datatype = "24"</outport>
<outport> id = "-1" name = "tau to CSE mocell (only use for HIL testing)/X_d" width = "1" datatype = "24"</outport>
<outport> id = "-1" name = "tau to CSE mocell (only use for HIL testing)/Y_d" width = "1" datatype = "24"</outport>
